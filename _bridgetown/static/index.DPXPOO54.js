(()=>{
    ...
    ;
    var pn = (a,t,e)=>(e = a != null ? rn(dn(a)) : {},
    fn(t || !a || !a.__esModule ? wt(e, "default", {
        value: a,
        enumerable: !0
    }) : e, a));
    var se = (a,t,e)=>(hn(a, typeof t != "symbol" ? t + "" : t, e),
    e);
    var tn = mn(ie=>{
        (function() {
            "use strict";
            ...
            a.prototype = {
                    ...
                    typeof s < "u" && s >= 0 && s <= 1) {
                        ...
                        for (var d = 0; d < r._howls.length; d++)
                            if (!r._howls[d]._webAudio)
                                for (var h = r._howls[d]._getSoundIds(), f = 0; f < h.length; f++) {
                ...
                mute: function(s) {
                    ...
                    r.ctx || m(),
                    r._muted = s,
                    r.usingWebAudio && r.masterGain.gain.setValueAtTime(s ? 0 : r._volume, t.ctx.currentTime);
                    for (var d = 0; d < r._howls.length; d++)
                        if (!r._howls[d]._webAudio)
                            for (var h = r._howls[d]._getSoundIds(), f = 0; f < h.length; f++) {
                                var b = r._howls[d]._soundById(h[f]);
                ...
                _setupCodecs: function() {
                    ...
                    return s._codecs = {
                        mp3: !!(!b && (d || r.canPlayType("audio/mp3;").replace(/^no$/, ""))),
                        mpeg: !!d,
                        ...
                        weba: !!(!Q && r.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                        webm: !!(!Q && r.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                        ...
                        var r = function(d) {
                            ...
                            for (var f = 0; f < s._howls.length; f++)
                                if (!s._howls[f]._webAudio)
                                    for (var b = s._howls[f]._getSoundIds(), p = 0; p < b.length; p++) {
                ...
                _releaseHtml5Audio: function(s) {
                    var r = this || t;
                    return s._unlocked && r._html5AudioPool.push(s),
                    r
                },
                        ...
                        for (var r = 0; r < s._howls.length; r++)
                            if (s._howls[r]._webAudio) {
                                for (var d = 0; d < s._howls[r]._sounds.length; d++)
                                    if (!s._howls[r]._sounds[d]._paused)
                                        return s
                            }
            ...
            e.prototype = {
                init: function(s) {
                    ...
                    r._loop = s.loop || !1,
                    r._pool = s.pool || 5,
                    r._preload = typeof s.preload == "boolean" || s.preload === "metadata" ? s.preload : !0,
                    r._rate = s.rate || 1,
                    r._sprite = s.sprite || {},
                ...
                load: function() {
                    ...
                    return s._src = r,
                    s._state = "loading",
                    window.location.protocol === "https:" && r.slice(0, 5) === "http:" && (s._html5 = !0,
                    s._webAudio = !1),
                    new i(s),
                    s._webAudio && o(s),
                    s
                ...
                play: function(s, r) {
                    ...
                    if (typeof s == "number")
                        ...
                        !d._playLock)) {
                            for (var f = 0, b = 0; b < d._sounds.length; b++)
                                d._sounds[b]._paused && !d._sounds[b]._ended && (f++,
                                h = d._sounds[b]._id);
                            f === 1 ? s = null : h = null
                        }
                    }
                    ...
                    if (d._webAudio) {
                        var Bt = function() {
                            ...
                            typeof x.bufferSource.start > "u" ? p._loop ? x.bufferSource.noteGrainOn(0, Q, 86400) : x.bufferSource.noteGrainOn(0, Q, y) : p._loop ? x.bufferSource.start(0, Q, 86400) : x.bufferSource.start(0, Q, y),
                            B !== 1 / 0 && (d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), B)),
                            r || setTimeout(function() {
                                d._emit("play", p._id),
                                d._loadQueue()
                            }, 0)
                        };
                        t.state === "running" && t.ctx.state !== "interrupted" ? Bt() : (d._playLock = !0,
                        d.once("resume", Bt),
                        d._clearTimer(p._id))
                    } else {
                        var xt = function() {
                            ...
                            try {
                                ...
                                s !== "__default" || p._loop ? d._endTimers[p._id] = setTimeout(d._ended.bind(d, p), B) : (d._endTimers[p._id] = function() {
                                    d._ended(p),
                        ...
                        x.load());
                        var Ut = window && window.ejecta || !x.readyState && t._navigator.isCocoonJS;
                        if (x.readyState >= 3 || Ut)
                            xt();
                        else {
                            d._playLock = !0,
                            d._state = "loading";
                            ...
                            x.addEventListener(t._canPlayEvent, ht, !1),
                            d._clearTimer(p._id)
                        }
                    }
                    return p._id
                ...
                pause: function(s) {
                    ...
                    for (var d = r._getSoundIds(s), h = 0; h < d.length; h++) {
                        ...
                        if (f && !f._paused && (f._seek = r.seek(d[h]),
                        f._rateSeek = 0,
                        f._paused = !0,
                        r._stopFade(d[h]),
                        f._node))
                            if (r._webAudio) {
                                if (!f._node.bufferSource)
                                    continue;
                                typeof f._node.bufferSource.stop > "u" ? f._node.bufferSource.noteOff(0) : f._node.bufferSource.stop(0),
                ...
                stop: function(s, r) {
                    ...
                    for (var h = d._getSoundIds(s), f = 0; f < h.length; f++) {
                        ...
                        b && (b._seek = b._start || 0,
                        b._rateSeek = 0,
                        b._paused = !0,
                        b._ended = !0,
                        d._stopFade(h[f]),
                        b._node && (d._webAudio ? b._node.bufferSource && (typeof b._node.bufferSource.stop > "u" ? b._node.bufferSource.noteOff(0) : b._node.bufferSource.stop(0),
                        d._cleanBuffer(b._node)) : (!isNaN(b._node.duration) || b._node.duration === 1 / 0) && (b._node.currentTime = b._start || 0,
                        b._node.pause(),
                ...
                mute: function(s, r) {
                    ...
                    for (var h = d._getSoundIds(r), f = 0; f < h.length; f++) {
                        ...
                        d._webAudio && b._node ? b._node.gain.setValueAtTime(s ? 0 : b._volume, t.ctx.currentTime) : b._node && (b._node.muted = t._muted ? !0 : s),
                        d._emit("mute", b._id))
                    }
                    return d
                },
                volume: function() {
                    var s = this, r = arguments, d, h;
                    if (r.length === 0)
                        return s._volume;
                    ...
                    if (typeof d < "u" && d >= 0 && d <= 1) {
                        ...
                        for (var g = 0; g < h.length; g++)
                            ...
                            p && (p._volume = d,
                            r[2] || s._stopFade(h[g]),
                            s._webAudio && p._node && !p._muted ? p._node.gain.setValueAtTime(d, t.ctx.currentTime) : p._node && !p._muted && (p._node.volume = d * t.volume()),
                            s._emit("volume", p._id))
                    } else
                        return p = h ? s._soundById(h) : s._sounds[0],
                        p ? p._volume : 0;
                    return s
                },
                fade: function(s, r, d, h) {
                    ...
                    for (var b = f._getSoundIds(h), p = 0; p < b.length; p++) {
                        ...
                        if (g) {
                            if (h || f._stopFade(b[p]),
                            f._webAudio && !g._muted) {
                ...
                _startFadeInterval: function(s, r, d, h, f, b) {
                    ...
                    s._interval = setInterval(function() {
                        ...
                        b && (p._volume = g),
                        (d < r && g <= d || d > r && g >= d) && (clearInterval(s._interval),
                        s._interval = null,
                        s._fadeTo = null,
                        p.volume(d, s._id),
                        p._emit("fade", s._id))
                ...
                _stopFade: function(s) {
                    var r = this
                      , d = r._soundById(s);
                    return d && d._interval && (r._webAudio && d._node.gain.cancelScheduledValues(t.ctx.currentTime),
                ...
                loop: function() {
                    ...
                    if (r.length === 1)
                        if (typeof r[0] == "boolean")
                            ...
                            return f = s._soundById(parseInt(r[0], 10)),
                            f ? f._loop : !1;
                    else
                        r.length === 2 && (d = r[0],
                        h = parseInt(r[1], 10));
                    for (var b = s._getSoundIds(h), p = 0; p < b.length; p++)
                        f = s._soundById(b[p]),
                        f && (f._loop = d,
                        s._webAudio && f._node && f._node.bufferSource && (f._node.bufferSource.loop = d,
                        d && (f._node.bufferSource.loopStart = f._start || 0,
                        f._node.bufferSource.loopEnd = f._stop,
                        s.playing(b[p]) && (s.pause(b[p], !0),
                        s.play(b[p], !0)))));
                    return s
                },
                rate: function() {
                    ...
                    if (typeof d == "number") {
                        ...
                        h = s._getSoundIds(h);
                        for (var g = 0; g < h.length; g++)
                            if (p = s._soundById(h[g]),
                            p) {
                                s.playing(h[g]) && (p._rateSeek = s.seek(h[g]),
                                p._playStart = s._webAudio ? t.ctx.currentTime : p._playStart),
                                p._rate = d,
                                s._webAudio && p._node && p._node.bufferSource ? p._node.bufferSource.playbackRate.setValueAtTime(d, t.ctx.currentTime) : p._node && (p._node.playbackRate = d);
                                var Q = s.seek(h[g])
                                  , y = (s._sprite[p._sprite][0] + s._sprite[p._sprite][1]) / 1e3 - Q
                                  , B = y * 1e3 / Math.abs(p._rate);
                                (s._endTimers[h[g]] || !p._paused) && (s._clearTimer(h[g]),
                                s._endTimers[h[g]] = setTimeout(s._ended.bind(s, p), B)),
                                s._emit("rate", p._id)
                            }
                    } else
                        return p = s._soundById(h),
                        p ? p._rate : s._rate;
                    return s
                },
                seek: function() {
                    ...
                    if (r.length === 0)
                        ...
                        var f = s._getSoundIds()
                          , b = f.indexOf(r[0]);
                        b >= 0 ? h = parseInt(r[0], 10) : s._sounds.length && (h = s._sounds[0]._id,
                        d = parseFloat(r[0]))
                    } else
                        r.length === 2 && (d = parseFloat(r[0]),
                        h = parseInt(r[1], 10));
                ...
                duration: function(s) {
                    var r = this
                      , d = r._duration
                      , h = r._soundById(s);
                    return h && (d = r._sprite[h._sprite][1] / 1e3),
                    d
                },
                state: function() {
                    return this._state
                ...
                unload: function() {
                    for (var s = this, r = s._sounds, d = 0; d < r.length; d++)
                        ...
                        s._webAudio || (s._clearSound(r[d]._node),
                        r[d]._node.removeEventListener("error", r[d]._errorFn, !1),
                        r[d]._node.removeEventListener(t._canPlayEvent, r[d]._loadFn, !1),
                ...
                on: function(s, r, d, h) {
                    var f = this
                      , b = f["_on" + s];
                    return typeof r == "function" && b.push(h ? {
                        id: d,
                        fn: r,
                        once: h
                    } : {
                ...
                off: function(s, r, d) {
                    ...
                    r || d)
                        ...
                        for (b = 0; b < g.length; b++)
                            g[b].indexOf("_on") === 0 && Array.isArray(h[g[b]]) && (h[g[b]] = [])
                    }
                    return h
                },
                once: function(s, r, d) {
                ...
                _emit: function(s, r, d) {
                    for (var h = this, f = h["_on" + s], b = f.length - 1; b >= 0; b--)
                        (!f[b].id || f[b].id === r || s === "load") && (setTimeout(function(p) {
                            p.call(this, r, d)
                        }
                        .bind(h, f[b].fn), 0),
                        f[b].once && h.off(s, f[b].fn, f[b].id));
                    return h._loadQueue(s),
                    h
                },
                ...
                _ended: function(s) {
                    var r = this
                      , d = s._sprite;
                    if (!r._webAudio && s._node && !s._node.paused && !s._node.ended && s._node.currentTime < s._stop)
                        return setTimeout(r._ended.bind(r, s), 100),
                        r;
                    var h = !!(s._loop || r._sprite[d][2]);
                    if (r._emit("end", s._id),
                    ...
                    return r._webAudio && !h && (s._paused = !0,
                    s._ended = !0,
                    s._seek = s._start || 0,
                    s._rateSeek = 0,
                    r._clearTimer(s._id),
                ...
                _inactiveSound: function() {
                    ...
                    for (var r = 0; r < s._sounds.length; r++)
                        if (s._sounds[r]._ended)
                            return s._sounds[r].reset();
                    return new i(s)
                },
                _drain: function() {
                    var s = this
                    ...
                    if (!(s._sounds.length < r)) {
                        ...
                        for (h = s._sounds.length - 1; h >= 0; h--) {
                            if (d <= r)
                                return;
                            s._sounds[h]._ended && (s._webAudio && s._sounds[h]._node && s._sounds[h]._node.disconnect(0),
                ...
                _refreshBuffer: function(s) {
                    var r = this;
                    return s._node.bufferSource = t.ctx.createBufferSource(),
                    ...
                    s._node.bufferSource.playbackRate.setValueAtTime(s._rate, t.ctx.currentTime),
                    r
                },
                _cleanBuffer: function(s) {
                    ...
                    if (!s.bufferSource)
                        return r;
                    if (t._scratchBuffer && s.bufferSource && (s.bufferSource.onended = null,
            ...
            i.prototype = {
                ...
                create: function() {
                    ...
                    return r._webAudio ? (s._node = typeof t.ctx.createGain > "u" ? t.ctx.createGainNode() : t.ctx.createGain(),
                    s._node.gain.setValueAtTime(d, t.ctx.currentTime),
                    s._node.paused = !0,
                    s._node.connect(t.masterGain)) : t.noAudio || (s._node = t._obtainHtml5Audio(),
                ...
                _endListener: function() {
                    var s = this
                      , r = s._parent;
                    r._duration === 1 / 0 && (r._duration = Math.ceil(s._node.duration * 10) / 10,
            ...
            var n = {}
              , o = function(s) {
                var r = s._src;
                if (n[r]) {
                    s._duration = n[r].duration,
                    u(s);
                    return
                }
                if (/^data:[^;]+;base64,/.test(r)) {
                    for (var d = atob(r.split(",")[1]), h = new Uint8Array(d.length), f = 0; f < d.length; ++f)
                        h[f] = d.charCodeAt(f);
                    c(h.buffer, s)
                } else {
                    ...
                    b.onload = function() {
                        var p = (b.status + "")[0];
                        if (p !== "0" && p !== "2" && p !== "3") {
                            s._emit("loaderror", null, "Failed loading audio file with status: " + b.status + ".");
                            return
                        }
                        c(b.response, s)
                    }
              ...
              , c = function(s, r) {
                var d = function() {
                  ...
                  , h = function(f) {
                    f && r._sounds.length > 0 ? (n[r._src] = f,
                    u(r, f)) : d()
                };
            ...
            typeof ie < "u" && (ie.Howler = t,
            ie.Howl = e),
            typeof global < "u" ? (global.HowlerGlobal = a,
            global.Howler = t,
            global.Howl = e,
            global.Sound = i) : typeof window < "u" && (window.HowlerGlobal = a,
            window.Howler = t,
            window.Howl = e,
            window.Sound = i)
        }
        ...
        (function() {
            ...
            HowlerGlobal.prototype.pos = function(t, e, i) {
                ...
                if (!n.ctx || !n.ctx.listener)
                    return n;
                if (e = typeof e != "number" ? n._pos[1] : e,
            ...
            HowlerGlobal.prototype.orientation = function(t, e, i, n, o, l) {
                ...
                typeof t == "number")
                    ...
                    c.ctx.listener.forwardY.setTargetAtTime(e, Howler.ctx.currentTime, .1),
                    ...
                    c.ctx.listener.upZ.setTargetAtTime(l, Howler.ctx.currentTime, .1)) : c.ctx.listener.setOrientation(t, e, i, n, o, l);
                else
                    return u;
                return c
            }
                ...
                for (var o = i._getSoundIds(e), l = 0; l < o.length; l++) {
                    ...
                    if (c)
                        if (typeof t == "number")
                            ...
                            n === "spatial" ? typeof c._panner.positionX < "u" ? (c._panner.positionX.setValueAtTime(t, Howler.ctx.currentTime),
            ...
            Howl.prototype.pos = function(t, e, i, n) {
                ...
                for (var l = o._getSoundIds(n), c = 0; c < l.length; c++) {
                    ...
                    if (u)
                        if (typeof t == "number")
                            u._pos = [t, e, i],
                            u._node && ((!u._panner || u._panner.pan) && a(u, "spatial"),
                            typeof u._panner.positionX < "u" ? (u._panner.positionX.setValueAtTime(t, Howler.ctx.currentTime),
                            u._panner.positionY.setValueAtTime(e, Howler.ctx.currentTime),
                            u._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : u._panner.setPosition(t, e, i)),
                            o._emit("pos", u._id);
                        else
                            return u._pos
                }
            ...
            Howl.prototype.orientation = function(t, e, i, n) {
                ...
                if (o._state !== "loaded")
                    ...
                    o;
                if (e = typeof e != "number" ? o._orientation[1] : e,
                i = typeof i != "number" ? o._orientation[2] : i,
                typeof n > "u")
                    if (typeof t == "number")
                        o._orientation = [t, e, i];
                    else
                ...
                for (var l = o._getSoundIds(n), c = 0; c < l.length; c++) {
                    ...
                    if (u)
                        if (typeof t == "number")
                            ...
                            a(u, "spatial")),
                            typeof u._panner.orientationX < "u" ? (u._panner.orientationX.setValueAtTime(t, Howler.ctx.currentTime),
                            u._panner.orientationY.setValueAtTime(e, Howler.ctx.currentTime),
                            u._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : u._panner.setOrientation(t, e, i)),
            ...
            Sound.prototype.reset = function(t) {
                return function() {
                    ...
                    e._pos = i._pos,
                    e._pannerAttr = i._pannerAttr,
                    e._stereo ? i.stereo(e._stereo) : e._pos ? i.pos(e._pos[0], e._pos[1], e._pos[2], e._id) : e._panner && (e._panner.disconnect(0),
                    e._panner = void 0,
                    i._refreshBuffer(e)),
                    t.call(this)
                }
            ...
            var a = function(t, e) {
                e = e || "spatial",
                e === "spatial" ? (t._panner = Howler.ctx.createPanner(),
    ...
    ;
    function bn(a) {
        if ("immediatePropagationStopped"in a)
            return a;
        {
    ...
    var ae = class {
        ...
        removeMappedEventListenerFor(t) {
            let {eventTarget: e, eventName: i, eventOptions: n} = t
              ...
              , l = this.cacheKey(i, n);
            o.delete(l),
            o.size == 0 && this.eventListenerMaps.delete(e)
        }
        ...
        fetchEventListener(t, e, i) {
            let n = this.fetchEventListenerMapForEventTarget(t)
              , o = this.cacheKey(e, i)
              , l = n.get(o);
            return l || (l = this.createEventListener(t, e, i),
            n.set(o, l)),
            l
        }
    ...
    function Fn(a) {
        let e = a.trim().match(Qn) || []
          , i = e[2]
          , n = e[3];
        return n && !["keydown", "keyup", "keypress"].includes(i) && (i += `.${n}`,
        n = ""),
        {
            eventTarget: yn(e[4]),
            eventName: i,
    ...
    function vn(a) {
        return a.split(":").reduce((t,e)=>Object.assign(t, {
            [e.replace(/^!/, "")]: !/^!/.test(e)
        }), {})
    }
    function Bn(a) {
    ...
    var si = ["meta", "ctrl", "alt", "shift"]
      , ce = class {
        ...
        shouldIgnoreKeyboardEvent(t) {
            ...
            return i ? (le(this.keyMappings, i) || Lt(`contains unknown key filter: ${this.keyFilter}`),
            this.keyMappings[i].toLowerCase() !== t.key.toLowerCase()) : !1
        }
        ...
        keyFilterDissatisfied(t, e) {
            ...
            return t.metaKey !== i || t.ctrlKey !== n || t.altKey !== o || t.shiftKey !== l
        }
    }
      , oi = {
        a: ()=>"click",
    ...
    var ue = class {
        ...
        matchElementsInTree(t) {
            ...
            if (e) {
                let i = this.matchElement(t) ? [t] : []
                  , n = Array.from(t.querySelectorAll(e)).filter(o=>this.matchElement(o));
                return i.concat(n)
            } else
                return []
        }
        ...
        elementAttributeChanged(t, e) {
            ...
            if (i) {
                ...
                n && !o ? this.selectorMatched(t, i) : !n && o && this.selectorUnmatched(t, i)
            }
        }
        selectorMatched(t, e) {
      ...
      , he = class {
        ...
        refreshAttribute(t, e) {
            ...
            if (i != null) {
                ...
                if (this.stringMap.get(t) != n && this.stringMapValueChanged(n, i, e),
                n == null) {
                    let o = this.stringMap.get(t);
                    this.stringMap.delete(t),
                    o && this.stringMapKeyRemoved(i, t, o)
                } else
    ...
    ;
    function En(a, t, e) {
        return a.trim().split(/\s+/).filter(i=>i.length).map((i,n)=>({
            element: t,
            attributeName: e,
            content: i,
            index: n
    ...
    var Zt = class {
        ...
        tokenMatched(t) {
            ...
            i && (this.fetchValuesByTokenForElement(e).set(t, i),
            this.delegate.elementMatchedValue(e, i))
        }
        tokenUnmatched(t) {
            let {element: e} = t
              , {value: i} = this.fetchParseResultForToken(t);
            i && (this.fetchValuesByTokenForElement(e).delete(t),
      ...
      , me = class {
        ...
        start() {
            this.valueListObserver || (this.valueListObserver = new Zt(this.element,this.actionAttribute,this),
      ...
      , fe = class {
        ...
        stringMapValueChanged(t, e, i) {
            ...
            t !== null && (i === null && (i = n.writer(n.defaultValue)),
        ...
        invokeChangedCallbacksForDefaultValues() {
            for (let {key: t, name: e, defaultValue: i, writer: n} of this.valueDescriptors)
            ...
            if (typeof o == "function") {
                ...
                try {
                    let c = l.reader(e)
                      , u = i;
                    i && (u = l.reader(i)),
                    o.call(this.receiver, c, u)
                } catch (c) {
                    throw c instanceof TypeError && (c.message = `Stimulus Value "${this.context.identifier}.${l.name}" - ${c.message}`),
                    c
                }
            }
        }
      ...
      , pe = class {
        constructor(t, e) {
            this.context = t,
            this.delegate = e,
            this.targetsByName = new j
        }
        start() {
            this.tokenListObserver || (this.tokenListObserver = new Et(this.element,this.attributeName,this),
            this.tokenListObserver.start())
        }
        stop() {
        ...
        connectTarget(t, e) {
            ...
            (i = this.tokenListObserver) === null || i === void 0 || i.pause(()=>this.delegate.targetConnected(t, e)))
        }
        disconnectTarget(t, e) {
            var i;
            this.targetsByName.has(e, t) && (this.targetsByName.delete(e, t),
            (i = this.tokenListObserver) === null || i === void 0 || i.pause(()=>this.delegate.targetDisconnected(t, e)))
        }
    ...
    function pt(a, t) {
        let e = fi(a);
        return Array.from(e.reduce((i,n)=>(Mn(n, t).forEach(o=>i.add(o)),
        i), new Set))
    }
    function On(a, t) {
        return fi(a).reduce((i,n)=>(i.push(...In(n, t)),
        i), [])
    }
    function fi(a) {
        let t = [];
    ...
    var be = class {
        ...
        connectOutlet(t, e, i) {
            var n;
            this.outletElementsByName.has(i, e) || (this.outletsByName.add(i, t),
            this.outletElementsByName.add(i, e),
            (n = this.selectorObserverMap.get(i)) === null || n === void 0 || n.pause(()=>this.delegate.outletConnected(t, e, i)))
        }
        disconnectOutlet(t, e, i) {
            var n;
            this.outletElementsByName.has(i, e) && (this.outletsByName.delete(i, t),
            this.outletElementsByName.delete(i, e),
            (n = this.selectorObserverMap.get(i)) === null || n === void 0 || n.pause(()=>this.delegate.outletDisconnected(t, e, i)))
        }
    ...
    function Vn(a, t) {
        let e = Gn(a)
          , i = _n(a.prototype, t);
        return Object.defineProperties(e.prototype, i),
        e
    }
    function Yn(a) {
    ...
    function Dn(a, t, e) {
        ...
        if (!(i && "value"in i)) {
            ...
            return i && (o.get = i.get || o.get,
            o.set = i.set || o.set),
            o
        }
    }
    var Xn = typeof Object.getOwnPropertySymbols == "function" ? a=>[...Object.getOwnPropertyNames(a), ...Object.getOwnPropertySymbols(a)] : Object.getOwnPropertyNames
      , Gn = (()=>{
        function a(e) {
            function i() {
    ...
    var Qe = class {
      ...
      , ve = class {
        ...
        warn(t, e, i) {
            ...
            n || (n = new Set,
            this.warnedKeysByObject.set(t, n)),
            n.has(e) || (n.add(e),
    ...
    var xe = class {
        ...
        findAll(...t) {
            return t.reduce((e,i)=>[...e, ...this.findAllTargets(i), ...this.findAllLegacyTargets(i)], [])
        }
        findTarget(t) {
        ...
        deprecate(t, e) {
            if (t) {
                ...
                this.guide.warn(t, `target:${e}`, `Please replace ${n}="${i}.${e}" with ${o}="${e}". The ${n} attribute is deprecated and will be removed in a future version of Stimulus.`)
            }
            return t
        }
        get guide() {
      ...
      , we = class a {
        constructor(t, e, i, n) {
            ...
            this.containsElement = o=>o.closest(this.controllerSelector) === this.element,
            this.schema = t,
            this.element = e,
            this.identifier = i,
            this.guide = new ve(n),
        ...
        get documentScope() {
            return this.isDocumentScope ? this : new a(this.schema,document.documentElement,this.identifier,this.guide.logger)
        }
    }
      , Le = class {
        constructor(t, e, i) {
            ...
            this.schema = e,
            this.delegate = i,
            this.valueListObserver = new Zt(this.element,this.controllerAttribute,this),
        ...
        parseValueForElementAndIdentifier(t, e) {
            let i = this.fetchScopesByIdentifierForElement(t)
              , n = i.get(e);
            return n || (n = this.delegate.createScopeForElementAndIdentifier(t, e),
            i.set(e, n)),
            n
        }
        elementMatchedValue(t, e) {
        ...
        elementUnmatchedValue(t, e) {
            ...
            i && (this.scopeReferenceCounts.set(e, i - 1),
      ...
      , Tn = {
        ...
        keyMappings: Object.assign(Object.assign({
            ...
            page_up: "PageUp",
            page_down: "PageDown"
        }, ai("abcdefghijklmnopqrstuvwxyz".split("").map(a=>[a, a]))), ai("0123456789".split("").map(a=>[a, a])))
    };
    function ai(a) {
        return a.reduce((t,[e,i])=>Object.assign(Object.assign({}, t), {
            [e]: i
        }), {})
    }
    var kt = class {
...
%o`, e, t, i),
    ...
    function li(a, t, e) {
        let i = ri(a, t, e);
        if (i || (a.application.router.proposeToConnectScopeForElementAndIdentifier(t, e),
        i = ri(a, t, e),
        i))
            return i
    }
            ...
            [`${t}Outlet`]: {
                get() {
                    ...
                    if (e) {
                        ...
                        if (n)
                            return n;
                        throw new Error(`The provided outlet element is missing an outlet controller "${a}" instance for host controller "${this.identifier}"`)
                    }
                    throw new Error(`Missing outlet element "${a}" for host controller "${this.identifier}". Stimulus couldn't find a matching outlet element using selector "${i}".`)
                }
            },
            [`${t}Outlets`]: {
                get() {
                    ...
                    return e.length > 0 ? e.map(i=>{
                        ...
                        if (n)
                            return n;
                        console.warn(`The provided outlet element is missing an outlet controller "${a}" instance for host controller "${this.identifier}"`, i)
                    }
                    ).filter(i=>i) : []
                }
            },
        ...
        return {
            [`${a}Target`]: {
                get() {
                    ...
                    if (t)
                        return t;
                    throw new Error(`Missing target element "${a}" for "${this.identifier}" controller`)
                }
            },
            [`${a}Targets`]: {
                get() {
    ...
    function qn(a) {
        ...
        if (m !== s) {
            let r = t ? `${t}.${e}` : e;
            throw new Error(`The specified default value for the Stimulus Value "${r}" must match the defined type "${m}". The provided default value of "${i.default}" is of type "${s}".`)
        }
        if (l)
            return m
    }
    ...
    var ci = {
      ...
      , ns = {
        array(a) {
            let t = JSON.parse(a);
            if (!Array.isArray(t))
                throw new TypeError(`expected value of type "array" but instead got value "${a}" of type "${mt(t)}"`);
            return t
        },
        boolean(a) {
        ...
        object(a) {
            ...
            if (t === null || typeof t != "object" || Array.isArray(t))
                throw new TypeError(`expected value of type "object" but instead got value "${a}" of type "${mt(t)}"`);
            return t
        },
        string(a) {
            return a
    ...
    var _ = class {
        ...
        connect() {}
        disconnect() {}
        dispatch(t, {target: e=this.element, detail: i={}, prefix: n=this.identifier, bubbles: o=!0, cancelable: l=!0}={}) {
            let c = n ? `${n}:${t}` : t
              , u = new CustomEvent(c,{
                detail: i,
                bubbles: o,
    ...
    var F = (a,t=1e4)=>(a = parseFloat(a + "") || 0,
    Math.round((a + Number.EPSILON) * t) / t)
      , Se = function(a) {
        if (!(a && a instanceof Element && a.offsetParent))
            return !1;
      ...
      , St = function(a, t=void 0) {
        return !(!a || a === document.body || t && a === t) && (Se(a) ? a : St(a.parentElement, t))
    }
      , S = function(a) {
      ...
      , ze = class {
        ...
        , end: n=()=>{}
            ...
            this.moveCallback = i,
            this.endCallback = n;
            for (let o of ["onPointerStart", "onTouchStart", "onMove", "onTouchEnd", "onPointerEnd", "onWindowBlur"])
        ...
        onPointerStart(t) {
            if (!t.buttons || t.button !== 0)
                return;
            let e = new $(t);
            this.currentPointers.some(i=>i.id === e.id) || this.triggerPointerStart(e, t) && (window.addEventListener("mousemove", this.onMove),
        ...
        onMove(t) {
            let e = this.currentPointers.slice()
              , i = "changedTouches"in t ? Array.from(t.changedTouches || []).map(o=>new $(o)) : [new $(t)]
              , n = [];
            for (let o of i) {
                let l = this.currentPointers.findIndex(c=>c.id === o.id);
                l < 0 || (n.push(o),
                this.currentPointers[l] = o)
            }
            n.length && this.moveCallback(t, this.currentPointers.slice(), e)
        }
        onPointerEnd(t) {
            t.buttons > 0 && t.button !== 0 || (this.triggerPointerEnd(t, new $(t)),
    ...
    ;
    function bi(a, t) {
        return t ? Math.sqrt(Math.pow(t.clientX - a.clientX, 2) + Math.pow(t.clientY - a.clientY, 2)) : 0
    }
    function gi(a, t) {
        return t ? {
    ...
    var je = a=>typeof a == "object" && a !== null && a.constructor === Object && Object.prototype.toString.call(a) === "[object Object]"
      , V = (a,...t)=>{
        let e = t.length;
        for (let i = 0; i < e; i++) {
            let n = t[i] || {};
            Object.entries(n).forEach(([o,l])=>{
                ...
                je(l) ? Object.assign(a[o], V(c, l)) : Array.isArray(l) ? Object.assign(a, {
                    [o]: [...l]
                }) : Object.assign(a, {
                    [o]: l
                })
      ...
      , Ee = function(a, t) {
        return a.split(".").reduce((e,i)=>typeof e == "object" ? e[i] : void 0, t)
    }
      , ut = class {
        constructor(t={}) {
        ...
        option(t, ...e) {
            ...
            return i && typeof i == "function" && (i = i.call(this, this, ...e)),
            i
        }
        optionFor(t, e, i, ...n) {
            let o = Ee(e, t);
            var l;
            typeof (l = o) != "string" || isNaN(l) || isNaN(parseFloat(l)) || (o = parseFloat(o)),
            o === "true" && (o = !0),
            o === "false" && (o = !1),
            o && typeof o == "function" && (o = o.call(this, this, t, ...n));
            let c = Ee(e, this.options);
            return c && typeof c == "function" ? o = c.call(this, this, t, ...n, o) : o === void 0 && (o = c),
            o === void 0 ? i : o
        }
        cn(t) {
        ...
        localize(t, e=[]) {
            t = String(t).replace(/\{\{(\w+).?(\w+)?\}\}/g, (i,n,o)=>{
                let l = "";
                return o ? l = this.option(`${n[0] + n.toLowerCase().substring(1)}.l10n.${o}`) : n && (l = this.option(`l10n.${n}`)),
                l || (l = i),
                l
            }
            );
    ...
    var yt = class extends ut {
        ...
        attachPlugins(t={}) {
            ...
            for (let[i,n] of Object.entries(t)) {
                let o = this.option(i)
                  , l = this.plugins[i];
                l || o === !1 ? l && o === !1 && (l.detach(),
                delete this.plugins[i]) : e.set(i, new n(this,o || {}))
            }
            for (let[i,n] of e)
                this.plugins[i] = n,
                n.attach()
    ...
    var J = ["a", "b", "c", "d", "e", "f"]
      ...
      , Pe = '<div class="f-spinner"><svg viewBox="0 0 50 50">' + Qi + Qi + "</svg></div>"
      ...
      , st = class a extends yt {
        ...
        get isTouchDevice() {
            return ke === null && (ke = window.matchMedia("(hover: none)").matches),
            ke
        }
        get isMobile() {
            return Ze === null && (Ze = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)),
            Ze
        }
        get panMode() {
        ...
        constructor(t, e={}, i={}) {
            ...
            this.isContentLoading) {
                if (this.option("spinner")) {
                    ...
                    let l = S(Pe);
                    !t.contains(o) || o.parentElement instanceof HTMLPictureElement ? this.spinner = t.appendChild(l) : this.spinner = ((n = o.parentElement) === null || n === void 0 ? void 0 : n.insertBefore(l, o)) || null
                }
        ...
        onError() {
            this.state !== w.Destroy && (this.spinner && (this.spinner.remove(),
            this.spinner = null),
            this.stop(),
            this.detachEvents(),
            this.state = w.Error,
        ...
        getNextScale(t) {
            let {fullScale: e, targetScale: i, coverScale: n, maxScale: o, minScale: l} = this
              , c = l;
            switch (t) {
            case "toggleMax":
                c = i - l < .5 * (o - l) ? o : l;
        ...
        checkBounds(t=0, e=0) {
            let {current: i} = this
              ...
              , h = 0
              , f = 0;
            return m !== 1 / 0 && n < m ? h = m - n : s !== 1 / 0 && n > s && (h = s - n),
            r !== 1 / 0 && o < r ? f = r - o : d !== 1 / 0 && o > d && (f = d - o),
            Math.abs(h) < 1e-4 && (h = 0),
            Math.abs(f) < 1e-4 && (f = 0),
        ...
        setEdgeForce() {
            if (this.ignoreBounds || this.isDragging || this.panMode === D || this.targetScale < this.scale)
        ...
        onClick(t) {
            var e;
            t.type === "click" && t.detail === 0 && (this.dragOffset.x = 0,
            this.dragOffset.y = 0),
            this.isDragging && ((e = this.pointerTracker) === null || e === void 0 || e.clear(),
            this.trackingPoints = [],
            this.startDecelAnim());
            let i = t.target;
            ...
            let u = this.content.getBoundingClientRect()
              , m = this.dragStart;
            if (m.time && !this.canZoomOut() && (Math.abs(u.x - m.x) > 2 || Math.abs(u.y - m.y) > 2))
                return;
            this.dragStart.time = 0;
            let s = h=>{
                this.option("zoom", t) && h && typeof h == "string" && /(iterateZoom)|(toggle(Zoom|Full|Cover|Max)|(zoomTo(Fit|Cover|Max)))/.test(h) && typeof this[h] == "function" && (t.preventDefault(),
                this[h]({
                    event: t
                }))
            }
            ...
            this.clicks == 1 && (this.clickTimer = setTimeout(()=>{
                this.clicks === 1 ? (this.emit("click", t),
                !t.defaultPrevented && r && s(r)) : (this.emit("dblClick", t),
                t.defaultPrevented || s(d)),
                this.clicks = 0,
                this.clickTimer = null
            }
            , 350))) : (this.emit("click", t),
            !t.defaultPrevented && r && s(r))
        }
        addTrackingPoint(t) {
        ...
        onPointerMove(t, e, i) {
            if (this.option("touch", t) === !1 || !this.isDragging || e.length < 2 && this.panOnlyZoomed && F(this.targetScale) <= F(this.minScale) || (this.emit("touchMove", t),
            t.defaultPrevented))
                return;
            ...
            if (e.length > 1) {
                ...
                c = o.clientX - y.left - .5 * y.width,
                u = o.clientY - y.top - .5 * y.height
            }
            let m = bi(i[0], i[1])
              , s = bi(e[0], e[1])
              , r = m ? s / m : 1
            ...
            let f = F(this.targetScale) === F(this.minScale) && this.option("lockAxis");
            if (f && !this.lockedAxis)
                if (f === "xy" || f === "y" || t.type === "touchmove") {
                    if (Math.abs(this.dragOffset.x) < 6 && Math.abs(this.dragOffset.y) < 6)
                        return void t.preventDefault();
                    let y = Math.abs(180 * Math.atan2(this.dragOffset.y, this.dragOffset.x) / Math.PI);
                    ...
                    this.lockedAxis = f;
            if (St(t.target, this.content) && (f = "x",
            this.dragOffset.y = 0),
            f && f !== "xy" && this.lockedAxis !== f && F(this.targetScale) === F(this.minScale))
                return;
            t.cancelable && t.preventDefault(),
            this.container.classList.add(this.cn("isDragging"));
            let b = this.checkBounds(d, h);
            this.option("rubberband") ? (this.isInfinite !== "x" && (b.xDiff > 0 && d < 0 || b.xDiff < 0 && d > 0) && (d *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitWidth * b.xDiff))),
            this.isInfinite !== "y" && (b.yDiff > 0 && h < 0 || b.yDiff < 0 && h > 0) && (h *= Math.max(0, .5 - Math.abs(.75 / this.contentRect.fitHeight * b.yDiff)))) : (b.xDiff && (d = 0),
            b.yDiff && (h = 0));
            let p = this.targetScale
              , g = this.minScale
              , Q = this.maxScale;
            p < .5 * g && (r = Math.max(r, g)),
        ...
        onPointerUp(t, e, i) {
            ...
            St(t.target, this.content) && this.lockedAxis === "y" && (this.trackingPoints = []),
            this.emit("touchEnd", t),
            this.isDragging = !1,
            this.lockedAxis = !1,
            this.state !== w.Destroy && (t.defaultPrevented || this.startDecelAnim()))
        }
        startDecelAnim() {
            var t;
            ...
            if (u > 0) {
                ...
                y && (d = Math.max(Math.min(d, y), -1 * y),
                h = Math.max(Math.min(h, y), -1 * y))
            }
            d && (s = d / (1 / (1 - f) - 1)),
            h && (r = h / (1 / (1 - f) - 1)),
            (this.option("lockAxis") === "y" || this.option("lockAxis") === "xy" && this.lockedAxis === "y" && F(b) === this.minScale) && (s = d = 0),
            (this.option("lockAxis") === "x" || this.option("lockAxis") === "xy" && this.lockedAxis === "x" && F(b) === this.minScale) && (r = h = 0);
            let p = this.dragOffset.x
              , g = this.dragOffset.y
              , Q = this.option("dragMinThreshold") || 0;
            Math.abs(p) < Q && Math.abs(g) < Q && (s = r = 0,
            d = h = 0),
            (this.option("zoom") && (b < this.minScale - 1e-5 || b > this.maxScale + 1e-5) || e && !s && !r) && (f = .35),
            this.applyChange({
                panX: s,
                panY: r,
                friction: f
        ...
        onWheel(t) {
            var e = [-t.deltaX || 0, -t.deltaY || 0, -t.detail || 0].reduce(function(o, l) {
                return Math.abs(l) > Math.abs(o) ? l : o
            });
            let i = Math.max(-1, Math.min(1, e));
            if (this.emit("wheel", t, i),
            this.panMode === D || t.defaultPrevented)
                return;
            let n = this.option("wheel");
            n === "pan" ? (t.preventDefault(),
        ...
        setTransform() {
            ...
            for (let p of J) {
                let g = p == "e" || p === "f" ? It : as;
                o[p] = F(t[p], g),
                Math.abs(e[p] - t[p]) < (p == "e" || p === "f" ? .51 : .001) && (t[p] = e[p])
            }
        ...
        updateMetrics(t=!1) {
            var e;
            if (!this || this.state === w.Destroy || this.isContentLoading)
                return;
            ...
            let f = parseFloat(o.dataset.width || "") || (C=>{
                let T = 0;
                return T = C instanceof HTMLImageElement ? C.naturalWidth : C instanceof SVGElement ? C.width.baseVal.value : Math.max(C.offsetWidth, C.scrollWidth),
                T || 0
            }
            )(o)
              , b = parseFloat(o.dataset.height || "") || (C=>{
                let T = 0;
                return T = C instanceof HTMLImageElement ? C.naturalHeight : C instanceof SVGElement ? C.height.baseVal.value : Math.max(C.offsetHeight, C.scrollHeight),
                T || 0
            }
            )(o)
            ...
            B.style.cssText = k,
            l && (B.style.width = `${W}px`,
            B.style.height = `${x}px`),
            this.setTransform(),
            t !== !0 && this.emit("refresh"),
            this.ignoreBounds || (F(this.targetScale) < F(this.minScale) ? this.zoomTo(this.minScale, {
                friction: 0
            }) : this.targetScale > this.maxScale ? this.zoomTo(this.maxScale, {
                friction: 0
            }) : this.state === w.Init || this.checkBounds().inBounds || this.requestTick()),
            this.updateControls()
        }
        calculateBounds() {
            ...
            if (r === !0 || n && r === n)
                ...
                if (d.width === f && (p = d.width),
                d.width === b && (g = d.height),
                t > p) {
                    m = .5 * (t - p),
                    c = -1 * m;
                    let Q = .5 * (h.right - h.left);
                    c += Q,
                    m += Q
                }
                if (o > p && t < p && (c -= .5 * (o - p),
        ...
        updateControls() {
            ...
            let m = t.canZoomIn()
              ...
              , d = s && r;
            if (r && (F(o) < F(l) && !this.panOnlyZoomed && (d = !0),
            (F(n.width, 1) > F(n.fitWidth, 1) || F(n.height, 1) > F(n.fitHeight, 1)) && (d = !0)),
            ...
            for (let b of e.querySelectorAll("[data-panzoom-action]")) {
                ...
                p ? (b.removeAttribute("disabled"),
                b.removeAttribute("tabindex")) : g && (b.setAttribute("disabled", ""),
                b.setAttribute("tabindex", "-1"))
            }
        }
        panTo({x: t=this.target.e, y: e=this.target.f, scale: i=this.targetScale, friction: n=this.option("friction"), angle: o=0, originX: l=0, originY: c=0, flipX: u=!1, flipY: m=!1, ignoreBounds: s=!1}) {
            this.state !== w.Destroy && this.applyChange({
        ...
        applyChange({panX: t=0, panY: e=0, scale: i=1, angle: n=0, originX: o=-this.current.e, originY: l=-this.current.f, friction: c=this.option("friction"), flipX: u=!1, flipY: m=!1, ignoreBounds: s=!1, bounce: r=this.option("bounce")}) {
            let d = this.state;
            if (d === w.Destroy)
                return;
            this.rAF && (cancelAnimationFrame(this.rAF),
            ...
            m && (g = g.scale(1, -1));
            for (let Q of J)
                Q !== "e" && Q !== "f" && (g[Q] > this.minScale + 1e-5 || g[Q] < this.minScale - 1e-5) ? this.target[Q] = g[Q] : this.target[Q] = F(g[Q], It);
            (this.targetScale < this.scale || Math.abs(i - 1) > .1 || this.panMode === D || r === !1) && !s && this.clampTargetBounds(),
            d === w.Init ? this.animate() : this.isResting || (this.state = w.Panning,
            this.requestTick())
        }
        stop(t=!1) {
            ...
            for (let i of J)
                this.velocity[i] = 0,
                t === "current" ? this.current[i] = this.target[i] : t === "target" && (this.target[i] = this.current[i]);
            this.setTransform(),
            U(this.container, "is-scaling"),
            U(this.container, "is-animating"),
            this.isTicking = !1,
        ...
        panWithMouse(t, e=this.option("mouseMoveFriction")) {
            ...
            h > 1 && (r !== l && (r *= h),
            d !== c && (d *= h));
            let f = .5 * (r - l) - m / l * 100 / 100 * (r - l);
            f += .5 * (o.right - o.left);
            let b = .5 * (d - c) - s / c * 100 / 100 * (d - c);
            b += .5 * (o.bottom - o.top),
            this.applyChange({
        ...
        zoomWithWheel(t) {
            if (this.state === w.Destroy || this.state === w.Init)
                return;
            let e = Date.now();
            if (e - this.pwt < 45)
                return void t.preventDefault();
            this.pwt = e;
            var i = [-t.deltaX || 0, -t.deltaY || 0, -t.detail || 0].reduce(function(m, s) {
                return Math.abs(s) > Math.abs(m) ? s : m
            });
            let n = Math.max(-1, Math.min(1, i))
              , {targetScale: o, maxScale: l, minScale: c} = this
              , u = o * (100 + 45 * n) / 100;
            F(u) < F(c) && F(o) <= F(c) ? (this.cwd += Math.abs(n),
            u = c) : F(u) > F(l) && F(o) >= F(l) ? (this.cwd += Math.abs(n),
            u = l) : (this.cwd = 0,
            u = Math.max(Math.min(u, l), c)),
            this.cwd > this.option("wheelLimit") || (t.preventDefault(),
            F(u) !== F(o) && this.zoomTo(u, {
                event: t
            }))
        }
        canZoomIn() {
        ...
        zoomTo(t=1, {friction: e=X, originX: i=X, originY: n=X, event: o}={}) {
            if (this.isContentLoading || this.state === w.Destroy)
                return;
            ...
            o || i === X || n === X) {
                let r = this.content.getBoundingClientRect()
                  ...
                  , h = o ? o.clientX : d.left + .5 * d.width
                  , f = o ? o.clientY : d.top + .5 * d.height;
                i = h - r.left - .5 * r.width,
                n = f - r.top - .5 * r.height
            }
            let s = 1;
            typeof t == "number" ? s = t : t === "full" ? s = c : t === "cover" ? s = m : t === "max" ? s = u : t === "fit" ? s = 1 : t === "next" && (s = this.getNextScale("iterateZoom")),
            s = s / l || 1,
            e = e === X ? s > 1 ? .15 : .25 : e,
            this.applyChange({
                scale: s,
        ...
        reset(t) {
            if (this.state !== w.Init && this.state !== w.Destroy) {
                ...
                this.isResting || (this.friction = t === void 0 ? this.option("friction") : t,
    ...
    var Oe = a=>{
        if (typeof a == "string" || a instanceof HTMLElement)
            ...
            let t = a.thumb;
            t !== void 0 && (typeof t == "string" && (a.thumbSrc = t),
            t instanceof HTMLImageElement && (a.thumbEl = t,
            a.thumbElSrc = t.src,
            a.thumbSrc = t.src),
            delete a.thumb)
        }
      ...
      , zt = class extends Y {
        ...
        refresh() {
            ...
            c && this.cleanup();
            let u = this.build();
            if (z(u, this.cn("isDynamic"), !!l),
            c)
                for (let r = 0; r < e; r++)
                    u.append(this.createItem(r));
            let m, s = 0;
            for (let r of [...u.children]) {
                let d = s === this.instance.page;
                d && (m = r),
                z(r, this.cn("isCurrent"), d),
                (t = r.children[0]) === null || t === void 0 || t.setAttribute("aria-selected", d ? "true" : "false");
        ...
        createItem(t=0) {
            ...
            let n = S(this.instance.localize(this.option("dotTpl"), [["%d", t + 1]]).replace(/\%i/g, t + ""));
            return i.appendChild(n),
            (e = i.children[0]) === null || e === void 0 || e.setAttribute("role", "tab"),
            i
        }
        cleanup() {
    ...
    var Rt = "disabled"
      ...
      , jt = class extends Y {
        ...
        onRefresh() {
            ...
            let n = this.prev
              , o = this.next;
            n && o && (n.removeAttribute(Rt),
            o.removeAttribute(Rt),
            t.isInfinite || (i <= 0 && n.setAttribute(Rt, ""),
        ...
        addBtn(t) {
            ...
            v(n, this.cn("button") + " " + this.cn(t === Vt ? "isNext" : "isPrev"));
            let o = i.isRTL ? t === Vt ? xi : Vt : t;
            var l;
            return n.innerHTML = i.localize(this.option(`${o}Tpl`)),
            n.dataset[`carousel${l = t,
            l ? l.match("^[a-z]") ? l.charAt(0).toUpperCase() + l.substring(1) : l : ""}`] = "true",
    ...
    var Jt = class extends Y {
        ...
        attachEvents() {
            ...
            t.state === Z.Ready ? this.onNavReady(t) : t.on("ready", this.onNavReady),
            e.state === Z.Ready ? this.onTargetReady(e) : e.on("ready", this.onTargetReady))
        }
        onNavReady(t) {
        ...
        onNavTouch(t, e, i) {
            ...
            c.slideTo(d),
            u.slideTo(r, {
                friction: ((o = (n = this.nav) === null || n === void 0 ? void 0 : n.plugins) === null || o === void 0 ? void 0 : o.Sync.option("friction")) || 0
            }),
        ...
        onTargetChange() {
            ...
            if (!i || !n || n.state !== Z.Ready || i.state !== Z.Ready)
                return;
            let o = (e = (t = i.pages[i.page]) === null || t === void 0 ? void 0 : t.slides[0]) === null || e === void 0 ? void 0 : e.index
              , l = n.getPageForSlide(o);
            this.markSelectedSlide(o),
            n.slideTo(l, n.prevPage === null && i.prevPage === null ? {
                friction: 0
            } : void 0)
        }
        markSelectedSlide(t) {
            let e = this.nav;
            e && e.state === Z.Ready && (this.selectedIndex = t,
            [...e.slides].map(i=>{
      ...
      , dt = class a extends yt {
        ...
        get isInfinite() {
            let t = !1
              ...
              , l = o[0];
            return n.length >= 2 && l && e + l.dim >= i && (t = this.option("infinite")),
            t
        }
        get isRTL() {
        ...
        processOptions() {
            ...
            if (o && je(o))
                for (let[l,c] of Object.entries(o))
                    window.matchMedia(l).matches && je(c) && (n += l,
                    V(i, c));
            n === this.bp && this.state !== Z.Init || (this.bp = n,
            this.state === Z.Ready && (i.initialSlide = ((e = (t = this.pages[this.page]) === null || t === void 0 ? void 0 : t.slides[0]) === null || e === void 0 ? void 0 : e.index) || 0),
        ...
        initPanzoom() {
            ...
            this.panzoom = new st(this.viewport,V({}, {
                content: this.track,
                zoom: !1,
                panOnlyZoomed: !1,
        ...
        createPages() {
            ...
            n = (n === "auto" || e <= i) && this.option("fill") !== !1 ? 1 / 0 : parseFloat(n + "");
            let o = 0
              , l = 0
              , c = 0;
            for (let u of this.slides)
                (!t.length || l + u.dim - i > .05 || c >= n) && (t.push(ls()),
                o = t.length - 1,
                l = 0,
                c = 0),
                t[o].slides.push(u),
        ...
        processPages() {
            ...
            if (t.forEach((s,r)=>{
                var d;
                s.index = r,
                s.pos = ((d = s.slides[0]) === null || d === void 0 ? void 0 : d.pos) || 0,
                s.dim = 0;
                for (let[h,f] of s.slides.entries())
                    s.dim += f.dim,
                    h < s.slides.length - 1 && (s.dim += f.gap);
                c && s.pos + .5 * s.dim < .5 * i ? s.pos = 0 : c && s.pos + .5 * s.dim >= e - .5 * i ? s.pos = e - i : o && (s.pos += -.5 * (i - s.dim))
            }
            ),
            t.forEach(s=>{
                l && !n && e > i && (s.pos = Math.max(s.pos, 0),
                s.pos = Math.min(s.pos, e - i)),
                s.pos = F(s.pos, 1e3),
                s.dim = F(s.dim, 1e3),
                Math.abs(s.pos) <= .1 && (s.pos = 0)
            }
            ),
            n)
                return t;
            ...
            return t.forEach(s=>{
                ...
                m && r.pos === m.pos ? (m.dim += r.dim,
                m.slides = [...m.slides, ...r.slides]) : (r.index = u.length,
                m = r,
                u.push(r))
            }
            ),
        ...
        getSlideMetrics(t) {
            ...
            let n = this.isHorizontal ? "width" : "height"
              ...
              , c = t.el
              , u = !(!c || c.parentNode);
            if (c ? o = parseFloat(c.dataset[n] || "") || 0 : (c = document.createElement("div"),
            ...
            o)
                ...
                o = c.getBoundingClientRect()[n] * Math.max(1, ((e = window.visualViewport) === null || e === void 0 ? void 0 : e.scale) || 1);
                let s = c[this.isHorizontal ? "offsetWidth" : "offsetHeight"];
                s - 1 > o && (o = s)
            }
            let m = getComputedStyle(c);
            return m.boxSizing === "content-box" && (this.isHorizontal ? (o += parseFloat(m.paddingLeft) || 0,
            o += parseFloat(m.paddingRight) || 0) : (o += parseFloat(m.paddingTop) || 0,
            o += parseFloat(m.paddingBottom) || 0)),
            l = parseFloat(m[this.isHorizontal ? "marginRight" : "marginBottom"]) || 0,
            u ? (i = c.parentElement) === null || i === void 0 || i.removeChild(c) : t.el || c.remove(),
            {
                dim: F(o, 1e3),
                gap: F(l, 1e3)
            }
        ...
        repositionSlides() {
            let t, {isHorizontal: e, isRTL: i, isInfinite: n, viewport: o, viewportDim: l, contentDim: c, page: u, pages: m, slides: s, panzoom: r} = this, d = 0, h = 0, f = 0, b = 0;
            r ? b = -1 * r.current[this.axis] : m[u] && (b = m[u].pos || 0),
            t = e ? i ? "right" : "left" : "top",
            i && e && (b *= -1);
            for (let y of s) {
                let B = y.el;
                B ? (t === "top" ? (B.style.right = "",
                B.style.left = "") : B.style.top = "",
                y.index !== d ? B.style[t] = h === 0 ? "" : `${F(h, 1e3)}px` : B.style[t] = "",
                f += y.dim + y.gap,
                d++) : h += y.dim + y.gap
            }
            if (n && f && o) {
                ...
                l += parseFloat(y[B + k]);
                for (let W of s)
                    W.el && (F(W.pos) < F(l) && F(W.pos + W.dim + W.gap) < F(b) && F(b) > F(c - l) && (W.el.style[t] = `${F(h + f, 1e3)}px`),
                    F(W.pos + W.gap) >= F(c - l) && F(W.pos) > F(b + l) && F(b) < F(l) && (W.el.style[t] = `-${F(f, 1e3)}px`))
            }
            let p, g, Q = [...this.inTransition];
            if (Q.length > 1 && (p = m[Q[0]],
            g = m[Q[1]]),
            p && g) {
                let y = 0;
                for (let B of s)
                    B.el ? this.inTransition.has(B.index) && p.slides.indexOf(B) < 0 && (B.el.style[t] = `${F(y + (p.pos - g.pos), 1e3)}px`) : y += B.dim + B.gap
            }
        }
        createSlideEl(t) {
            ...
            v(n, t.customClass);
            let o = t.html;
            o && (o instanceof HTMLElement ? n.appendChild(o) : n.innerHTML = t.html + "");
            let l = [];
            i.forEach((s,r)=>{
                s.el && l.push(r)
            }
            ...
            let c = t.index
              , u = null;
            l.length && (u = i[l.reduce((s,r)=>Math.abs(r - c) < Math.abs(s - c) ? r : s)]);
        ...
        removeSlideEl(t, e=!1) {
            ...
            if (!i || !i.parentNode)
                return;
            let n = this.cn(Ui);
            if (i.classList.contains(n) && (U(i, n),
        ...
        transitionTo(t=0, e=this.option("transition")) {
            ...
            if (!m || !u[s] || u.length < 2 || Math.abs((((n = (i = u[c]) === null || i === void 0 ? void 0 : i.slides[0]) === null || n === void 0 ? void 0 : n.dim) || 0) - this.viewportDim) > 1)
                return !1;
            let r = t > c ? 1 : -1;
            this.isInfinite && (c === 0 && t === u.length - 1 && (r = -1),
            c === u.length - 1 && t === 0 && (r = 1));
            let d = u[s].pos * (this.isRTL ? 1 : -1);
            if (c === s && Math.abs(d - m.target[this.axis]) < 1)
                return !1;
            this.clearTransitions();
            let h = m.isResting;
            v(this.container, this.cn("inTransition"));
            let f = ((o = u[c]) === null || o === void 0 ? void 0 : o.slides[0]) || null
              , b = ((l = u[s]) === null || l === void 0 ? void 0 : l.slides[0]) || null;
            this.inTransition.add(b.index),
            this.createSlideEl(b);
            let p = f.el
              , g = b.el;
            h || e === _t || (e = "fadeFast",
            p = null);
            ...
            return p && (this.inTransition.add(f.index),
            f.transition = e,
        ...
        manageSlideVisiblity() {
            ...
            for (let n of this.inTransition)
                t.add(this.slides[n]);
            for (let n of t)
                this.createSlideEl(n),
                this.lazyLoadSlide(n);
            for (let n of e)
        ...
        markSelectedSlides() {
            ...
            if (e)
                for (let i of this.slides) {
                    ...
                    n.classList.contains("f-thumbs__slide") ? this.getVisibleSlides(0).has(i) ? n.removeAttribute(t) : n.setAttribute(t, "true") : this.pages[this.page].slides.includes(i) ? (n.classList.contains(e) || (v(n, e),
                    this.emit("selectSlide", i)),
                    n.removeAttribute(t)) : (n.classList.contains(e) && (U(n, e),
                    this.emit("unselectSlide", i)),
                    n.setAttribute(t, "true")))
                }
        }
        flipInfiniteTrack() {
            let {axis: t, isHorizontal: e, isInfinite: i, isRTL: n, viewportDim: o, contentDim: l} = this
              , c = this.panzoom;
            if (!c || !i)
                return;
            let u = c.current[t]
        ...
        lazyLoadSlide(t) {
            ...
            if (!e)
                return;
            let i = new Set
              , n = Array.from(e.querySelectorAll("[data-lazy-src],[data-lazy-srcset]"));
        ...
        onAnimationEnd(t) {
            ...
            c && l.substring(0, c.length + 2) === `f-${c}` && this.inTransition.delete(n),
        ...
        onDecel(t, e=0, i=0, n=0, o=0) {
            ...
            Math.abs(d) > 5 ? (m[h].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (h = p),
            h = l && c ? d < 0 ? h - 1 : h + 1 : d < 0 ? h + 1 : h - 1) : h = n === 0 && o === 0 ? h : p,
            this.slideTo(h, {
                transition: !1,
        ...
        onClick(t) {
            let e = t.target, i = e && R(e) ? e.dataset : null, n, o;
            i && (i.carouselPage !== void 0 ? (o = "slideTo",
            n = i.carouselPage) : i.carouselNext !== void 0 ? o = "slideNext" : i.carouselPrev !== void 0 && (o = "slidePrev")),
            o ? (t.preventDefault(),
            t.stopPropagation(),
            e && !e.hasAttribute("disabled") && this[o](n)) : this.emit("click", t)
        }
        onSlideTo(t) {
            let e = t.detail || 0;
        ...
        slideTo(t=0, {friction: e=this.option("friction"), transition: i=this.option("transition")}={}) {
            ...
            if (this.isInfinite) {
                let h = this.contentDim
                  , f = m.target[o] * r;
                s === 2 ? d += h * Math.floor(parseFloat(t + "") / 2) : d = [d, d - h, d + h].reduce(function(b, p) {
                    return Math.abs(p - f) < Math.abs(b - f) ? p : b
                })
            }
            d *= r,
            Math.abs(m.target[o] - d) < 1 || (m.panTo({
                x: l ? d : 0,
                y: l ? 0 : d,
                friction: e
            }),
        ...
        clearTransitions() {
            ...
            U(this.container, this.cn("inTransition"));
        ...
        addSlide(t, e) {
            var i, n, o, l;
            let c = this.panzoom
              , u = ((i = this.pages[this.page]) === null || i === void 0 ? void 0 : i.pos) || 0
              , m = ((n = this.pages[this.page]) === null || n === void 0 ? void 0 : n.dim) || 0
            ...
            this.updateMetrics(),
            c) {
                let h = ((o = this.pages[this.page]) === null || o === void 0 ? void 0 : o.pos) || 0
                  , f = ((l = this.pages[this.page]) === null || l === void 0 ? void 0 : l.dim) || 0
                  , b = this.pages.length || 1
                  , p = this.isRTL ? m - f : f - m
                  , g = this.isRTL ? u - h : h - u;
                s && b === 1 ? (t <= this.page && (c.current[this.axis] -= p,
                c.target[this.axis] -= p),
                c.panTo({
                    [this.isHorizontal ? "x" : "y"]: -1 * h
                })) : g && t <= this.page && (c.target[this.axis] -= g,
        ...
        updateMetrics() {
            let {panzoom: t, viewport: e, track: i, slides: n, isHorizontal: o, isInfinite: l} = this;
            if (!i)
                return;
            ...
            for (let[r,d] of n.entries()) {
                let h = 0
                  , f = 0;
                !d.el && m ? (h = m.dim,
                f = m.gap) : ({dim: h, gap: f} = this.getSlideMetrics(d),
                m = d),
                h = F(h, 1e3),
                f = F(f, 1e3),
                d.dim = h,
        ...
        getProgress(t, e=!1, i=!1) {
            ...
            let u = -1 * o.current.e
              ...
              , s = m
              , r = m;
            this.isInfinite && i !== !0 && (s = F((u - c.pos + l) / (1 * c.dim), 1e3),
        ...
        getVisibleSlides(t=0) {
            var e;
            let i = new Set
              , {panzoom: n, contentDim: o, viewportDim: l, pages: c, page: u} = this;
            if (l) {
                o = o + ((e = this.slides[this.slides.length - 1]) === null || e === void 0 ? void 0 : e.gap) || 0;
                let m = 0;
                m = n && n.state !== w.Init && n.state !== w.Destroy ? -1 * n.current[this.axis] : c[u] && c[u].pos || 0,
        ...
        getPageFromPosition(t) {
            let {viewportDim: e, contentDim: i, slides: n, pages: o, panzoom: l} = this
              , c = o.length
              , u = n.length
              , m = n[0]
              , s = n[u - 1]
            ...
            r && (b += .5 * e),
            this.isInfinite ? (b < m.pos - .5 * s.gap && (b -= i,
            f = -1),
            b > s.pos + s.dim + .5 * s.gap && (b -= i,
            f = 1)) : b = Math.max(m.pos || 0, Math.min(b, s.pos));
            let p = s
              , g = n.find(Q=>{
                let y = Q.pos - .5 * p.gap
                  , B = Q.pos + Q.dim + .5 * Q.gap;
                return p = Q,
                b >= y && b < B
            }
            );
        ...
        destroy() {
            if ([Z.Destroy].includes(this.state))
                return;
            this.state = Z.Destroy;
            let {container: t, viewport: e, track: i, slides: n, panzoom: o} = this
    ...
    var zi = function(a) {
        ...
        let m = u / e * 100;
        return Math.round(m)
    }, Ft = !(typeof window > "u" || !window.document || !window.document.createElement), Me, Ie = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(","), wi = a=>{
        if (a && Ft) {
            Me === void 0 && document.createElement("div").focus({
                get preventScroll() {
                    return Me = !0,
                    !1
                }
    ...
    , ji = ()=>{
        let a = document, t, e = "", i = "", n = "";
        return a.fullscreenEnabled ? (e = "requestFullscreen",
        i = "exitFullscreen",
        n = "fullscreenElement") : a.webkitFullscreenEnabled && (e = "webkitRequestFullscreen",
        i = "webkitExitFullscreen",
        n = "webkitFullscreenElement"),
        e && (t = {
            request: function(o=a.documentElement) {
                return e === "webkitRequestFullscreen" ? o[e](Element.ALLOW_KEYBOARD_INPUT) : o[e]()
            },
            exit: function() {
                return a[n] && a[i]()
            },
      ...
      , Ji = ()=>{
        ...
        if (e) {
            ...
            if (i && n) {
                ...
                t && t !== "true" && (a = "#" + t + (!o && i.slides.length > 1 ? "-" + (n.index + 1) : ""))
            }
        }
        return {
            hash: a,
    ...
    ;
    Ft && (/complete|interactive|loaded/.test(document.readyState) ? Wi() : document.addEventListener("DOMContentLoaded", Wi));
    var Xt = "is-zooming-in"
      , Pt = class extends Y {
        ...
        onClose() {
            ...
            if (!o || !u || !l || !c || c.isContentLoading || c.state === w.Init || c.state === w.Destroy)
                return;
            c.updateMetrics();
            ...
            this.process(t, e).then(n=>{
                ...
                if (c && m) {
                    let r = n.contentRect
                      ...
                      , h = null;
                    !m.opacity && d > 1200 && (h = document.createElement("img"),
                    v(h, "fancybox-ghost"),
                    h.src = c,
                    o.appendChild(h));
                    let f = ()=>{
                    ...
                    let r = this.optionFor(t, "initialSize")
                      ...
                      , b = !0;
                    i.isOpeningSlide(t) && (r === "full" ? n.zoomToFull(h) : r === "cover" ? n.zoomToCover(h) : r === "max" ? n.zoomToMax(h) : b = !1,
                    n.stop("current")),
        ...
        process(t, e) {
            return new Promise((i,n)=>{
                ...
                if (typeof u == "string" && (u = S(u)),
                !u || !R(u)) {
                    if (u = document.createElement("img"),
                    u instanceof HTMLImageElement) {
                        let m = ""
                          , s = t.caption;
                        m = typeof s == "string" && s ? s.replace(/<[^>]+>/gi, "").substring(0, 1e3) : `Image ${t.index + 1} of ${((o = l.carousel) === null || o === void 0 ? void 0 : o.pages.length) || 1}`,
                        u.src = e || "",
                        u.alt = m,
                        u.draggable = !1,
                ...
                t.panzoom = new st(c,V({
                    ...
                    click: (m,s)=>{
                        var r, d;
                        if (l.isCompact || l.isClosing() || t.index !== ((r = l.getSlide()) === null || r === void 0 ? void 0 : r.index))
                            return !1;
                        if (s) {
        ...
        zoomIn(t) {
            return new Promise((e,i)=>{
                ...
                let {x: s, y: r, scale: d, opacity: h} = m
                  , f = ()=>{
                    t.state !== I.Closing && (h && (c.style.opacity = Math.max(Math.min(1, 1 - (1 - l.scale) / (1 - d)), 0) + ""),
                    l.scale >= 1 && l.scale > l.targetScale - .1 && e(l))
                }
                  , b = Q=>{
                    (Q.scale < .99 || Q.scale > 1.01) && !Q.isDragging || (U(o, Xt),
                    c.style.opacity = "",
                ...
                l.stop("current");
                let p = {
                    event: l.panMode === "mousemove" ? n.prevMouseMoveEvent || n.options.event : void 0
                }
                  , g = this.optionFor(t, "initialSize");
                v(o, Xt),
                n.hideLoading(t),
                g === "full" ? l.zoomToFull(p) : g === "cover" ? l.zoomToCover(p) : g === "max" ? l.zoomToMax(p) : l.reset(.172)
            }
            )
        }
        getZoomInfo(t) {
            let {el: e, imageEl: i, thumbEl: n, panzoom: o} = t
              , l = this.instance
              , c = l.container;
            if (!e || !i || !n || !o || zi(n) < 3 || !this.optionFor(t, "zoom") || !c || l.state === O.Destroy || getComputedStyle(c).getPropertyValue("--f-images-zoom") === "0")
                return !1;
            let u = window.visualViewport || null;
            if ((u ? u.scale : 1) !== 1)
                return !1;
            let {top: m, left: s, width: r, height: d} = n.getBoundingClientRect()
            ...
            return k === "auto" && (k = Math.abs(r / d - b / p) > .1),
            {
                x: Q,
                y,
                scale: B,
      ...
      , Ei = (a,t={})=>{
        ...
        for (let[c,u] of [...i, ...Object.entries(t)]) {
            ...
            if (c === "t") {
                ...
                s && n.set("start", 60 * parseInt(s[2] || "0") + parseInt(s[3] || "0") + "")
            } else
                n.set(c, m)
        }
        let o = n + ""
  ...
  <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn't support embedded videos.</video>`,
      ...
      , hs = ["image", "html", "ajax", "inline", "clone", "iframe", "map", "pdf", "html5video", "youtube", "vimeo"]
      , Kt = class extends Y {
        ...
        onClearContent(t, e) {
            ...
            if (e.type === "inline" && n && o)
                ...
                setTimeout(()=>{
                    o && (n && o.parentNode && o.parentNode.insertBefore(n, o),
                    o.remove())
                }
                , 0),
                e.contentEl = void 0,
        ...
        onUnselectSlide(t, e, i) {
            ...
            if (i.type === bt) {
                try {
                    (o = (n = i.el) === null || n === void 0 ? void 0 : n.querySelector("video")) === null || o === void 0 || o.pause()
                } catch {}
                return
            }
            let l;
            ...
            l && i.iframeEl && i.iframeEl.contentWindow && i.iframeEl.contentWindow.postMessage(JSON.stringify(l), "*"),
        ...
        loadAjaxContent(t) {
            ...
            n.onreadystatechange = function() {
                n.readyState === XMLHttpRequest.DONE && i.state === O.Ready && (i.hideLoading(t),
                n.status === 200 ? i.setContent(t, n.responseText) : i.setError(t, n.status === 404 ? "{{AJAX_NOT_FOUND}}" : "{{AJAX_FORBIDDEN}}"))
            }
            ;
            let o = t.ajax || null;
            n.open(o ? "POST" : "GET", e + ""),
        ...
        setIframeContent(t) {
            ...
            for (let[c,u] of Object.entries(this.optionFor(t, "iframeAttr") || {}))
                o.setAttribute(c, u);
            o.onerror = ()=>{
            ...
            if (t.type !== "iframe" || l === !1)
                return o.setAttribute("src", t.src + ""),
                n.setContent(t, o, !1),
                this.resizeIframe(t),
            ...
            let i = ()=>{
                if (t.iframeEl && t.iframeEl.contentWindow) {
                    ...
                    if (t.iframeEl.dataset.ready === "true")
                        ...
                        n && t.iframeEl.contentWindow.postMessage(JSON.stringify(n), "*"),
        ...
        processType(t) {
            ...
            if (n = e.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
                let o = this.optionFor(t, H)
                  ...
                  , c = function(r, d) {
                    var h = {};
                    for (var f in r)
                        Object.prototype.hasOwnProperty.call(r, f) && d.indexOf(f) < 0 && (h[f] = r[f]);
                    if (r != null && typeof Object.getOwnPropertySymbols == "function") {
                        var b = 0;
                        for (f = Object.getOwnPropertySymbols(r); b < f.length; b++)
                            d.indexOf(f[b]) < 0 && Object.prototype.propertyIsEnumerable.call(r, f[b]) && (h[f[b]] = r[f[b]])
                    }
                    return h
                }(o, ["nocookie"])
                ...
                t.thumbSrc = t.thumbSrc || `https://i.ytimg.com/vi/${s}/mqdefault.jpg`,
                i = H
                ...
                let o = Ei(e, this.optionFor(t, q))
                  ...
                  , c = n[4] || "";
                t.videoId = l,
                t.src = `https://player.vimeo.com/video/${l}?${c ? `h=${c}${o ? "&" : ""}` : ""}${o}`,
                i = q
            }
            if (!i && t.triggerEl) {
            ...
            i || typeof e == "string" && (e.charAt(0) === "#" ? i = "inline" : (n = e.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (i = bt,
            t.videoFormat = t.videoFormat || "video/" + (n[1] === "ogv" ? "ogg" : n[1])) : e.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? i = Ci : e.match(/\.(pdf)((\?|#).*)?$/i) && (i = "pdf")),
            ...
            i = Ve) : (n = e.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) && (t.src = `https://maps.google.${n[1]}/maps?q=${n[2].replace("query=", "q=").replace("api=1", "")}&output=embed`,
            i = Ve),
        ...
        setAspectRatio(t) {
            let e = t.contentEl;
            if (!(t.el && e && t.type && [H, q, bt].includes(t.type)))
                return;
            let i, n = t.width || "auto", o = t.height || "auto";
            if (n === "auto" || o === "auto") {
                i = this.optionFor(t, "videoRatio");
                let m = (i + "").match(/(\d+)\s*\/\s?(\d+)/);
                i = m && m.length > 2 ? parseFloat(m[1]) / parseFloat(m[2]) : parseFloat(i + "")
            } else
                n && o && (i = n / o);
            if (!i)
                return;
            ...
            i < c / u ? (o = o === "auto" ? u : Math.min(u, o),
            e.style.width = "auto",
            e.style.height = `${o}px`) : (n = n === "auto" ? c : Math.min(c, n),
            e.style.width = `${n}px`,
            e.style.height = "auto")
        }
        attach() {
    ...
    var Gt = "play"
      ...
      , $t = class extends Y {
        ...
        createProgressBar() {
            ...
            this.removeProgressBar();
            let e = this.instance
              , i = ((t = e.pages[e.page]) === null || t === void 0 ? void 0 : t.slides) || []
              , n = this.option("progressParentEl");
            if (n || (n = (i.length === 1 ? i[0].el : null) || e.viewport),
            !n)
                return null;
            let o = document.createElement("div");
            return v(o, "f-progress"),
            n.prepend(o),
            this.progressBar = o,
            o.offsetHeight,
            o
            ...
            i && (e.options.Autoplay = V({
                ...
                on: {
                    ...
                    set: n=>{
                        ...
                        ((o = t.getSlide()) === null || o === void 0 ? void 0 : o.state) !== I.Ready && n.pause()
                    }
                    ,
                    stop: ()=>{
                    ...
                    resume: (n,o)=>{
                        var l, c, u;
                        !o || !o.cancelable || ((l = t.getSlide()) === null || l === void 0 ? void 0 : l.state) === I.Ready && (!((u = (c = t.carousel) === null || c === void 0 ? void 0 : c.panzoom) === null || u === void 0) && u.isResting) || o.preventDefault()
                    }
                }
            }),
            e.attachPlugins({
    ...
    Object.defineProperty(qt, "defaults", {
        ...
        value: {
            ...
            progressParentEl: a=>{
                var t;
                return ((t = a.instance.container) === null || t === void 0 ? void 0 : t.querySelector(".fancybox__toolbar [data-fancybox-toggle-slideshow]")) || a.instance.container
            }
            ,
            timeout: 3e3
        }
    ...
    var Zi = "isResting"
      ...
      , qi = class extends Y {
        ...
        onInitSlide(a, t) {
            ...
            e && (t.thumbSrc = e.thumbSrc || t.thumbSrc || "",
        ...
        onChange() {
            ...
            if (i && n && o) {
                if (i.isDragging) {
                    U(t, this.cn(Zi));
                    let c = ((a = n.pages[l]) === null || a === void 0 ? void 0 : a.pos) || 0;
                    c += e.getProgress(l) * (this[A] + this.thumbGap);
                    let u = o.getBounds();
                    -1 * c > u.x.min && -1 * c < u.x.max && o.panTo({
                        x: -1 * c,
                        friction: .12
                    })
                } else
                    z(t, this.cn(Zi), i.isResting);
                this.shiftModern()
            }
        }
        onRefresh() {
            this.updateProps();
            for (let a of this.instance.slides || [])
                this.resizeModernSlide(a);
            this.shiftModern()
        }
        isDisabled() {
        ...
        getThumb(a) {
            ...
            return {
                html: this.instance.localize(t, [["%i", a.index], ["%d", a.index + 1], ["%s", a.thumbSrc || "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"]])
            }
        }
        addSlide(a) {
            let t = this.carousel;
        ...
        getSlides() {
            ...
            for (let t of this.instance.slides || [])
                a.push(this.getThumb(t));
            return a
        }
        resizeModernSlide(a) {
            this.isModern && (a[Tt] = a[A] && a[at] ? Math.round(this[at] * (a[A] / a[at])) : this[Tt])
        }
        updateProps() {
            let a = this.container;
            if (!a)
                return;
            let t = e=>parseFloat(getComputedStyle(a).getPropertyValue("--f-thumb-" + e)) || 0;
            this.thumbGap = t("gap"),
        ...
        onClick(a) {
            ...
            let u = this[A]
              ...
              , [r,d] = o(m - u, s)
              , [h,f] = o(m + u, s);
            d && f ? (l = Math.abs(m - d.getBoundingClientRect().right) < Math.abs(m - f.getBoundingClientRect().left) ? r : h,
            l === i && (l = l === r ? h : r)) : d ? l = r : f && (l = h),
            l > -1 && e[l] && t.slideTo(l)
        }
        getShift(a) {
            var t;
            ...
            let o = e[Tt]
              ...
              , c = e.thumbGap
              , u = e.thumbExtraGap;
            if (!(!((t = n.slides[a]) === null || t === void 0) && t.el))
                return 0;
            let m = .5 * (o - l)
              , s = i.pages.length - 1
              , r = i.getProgress(0)
              ...
              , p = r < 0 && r > -1
              , g = d > 0 && d < 1;
            return a === 0 ? (f = b * Math.abs(r),
            g && r === 1 && (f -= b * Math.abs(d))) : a === s ? (f = b * Math.abs(d) * -1,
            p && d === -1 && (f += b * Math.abs(r))) : p || g ? (f = -1 * b,
            f += b * Math.abs(r),
            f += b * (1 - Math.abs(d))) : f = b * h,
            f
        }
        setProps(a) {
            var t;
        ...
        attach() {
            ...
            t.state === Z.Init ? t.on("initSlides", a.onInitSlides) : a.onInitSlides(),
    ...
    var ms = Object.assign(Object.assign({}, $i), {
      ...
      , te = class extends Y {
        ...
        onCreateSlide(t, e) {
            var i, n, o;
            let l = ((o = (n = (i = this.instance) === null || i === void 0 ? void 0 : i.carousel) === null || n === void 0 ? void 0 : n.slides[e.index]) === null || o === void 0 ? void 0 : o.type) || ""
              , c = e.el;
            if (c && l) {
                let u = `for-${l}`;
                ["video", "youtube", "vimeo", "html5video"].includes(l) && (u += " for-video"),
                v(c, u)
            }
        }
        onInit() {
            ...
            l.Carousel.on = V(((t = e.options.Carousel) === null || t === void 0 ? void 0 : t.on) || {}, {
                click: this.onClick,
            ...
            e.option("showOnStart") || (e.ref.state = P.Hidden,
            e.hidden = !0)
        }
        onResize() {
            var t;
        ...
        toggle() {
            let t = this.ref;
            if (t && !t.isDisabled())
                return t.state === P.Hidden ? (t.state = P.Init,
      ...
      , ee = class extends Y {
        ...
        onReady(t) {
            ...
            if (o === "auto") {
                let m = this.instance.carousel
                  , s = 0;
                if (m)
                    for (let r of m.slides)
                        (r.panzoom || r.type === "image") && s++;
                s || (o = !1)
            }
            o || (i = void 0);
            let l = 0
            ...
            if (i)
                for (let m of ["left", "middle", "right"])
                    for (let s of i[m]) {
                        ...
                        r && ((e = c[m]) === null || e === void 0 || e.push(r),
                        l++)
                    }
            let u = null;
            if (l && (u = this.createContainer()),
            u) {
        ...
        onClick(t) {
            ...
            if (u.fancyboxToggleSlideshow !== void 0) {
                t.preventDefault(),
                t.stopPropagation();
                let r = (i = n.carousel) === null || i === void 0 ? void 0 : i.plugins.Autoplay
                  , d = r.isActive;
                return l && l.panMode === "mousemove" && !d && l.reset(),
                void (d ? r.stop() : r.start())
            }
            let m = u.panzoomAction
              , s = u.panzoomChange;
            if ((s || m) && (t.preventDefault(),
            t.stopPropagation()),
            s) {
                let r = {};
                try {
        ...
        onRefresh() {
            ...
            for (let l of t.querySelectorAll('[data-panzoom-action="toggleZoom"],[data-panzoom-action="iterateZoom"]')) {
                o || n ? (l.removeAttribute("disabled"),
                l.removeAttribute("tabindex")) : (l.setAttribute("disabled", ""),
                l.setAttribute("tabindex", "-1"));
        ...
        createEl(t) {
            ...
            if (t === "slideshow" && (!i.plugins.Autoplay || o < 2))
                return null;
            if (Ye[t] !== void 0) {
                let m = Ye[t];
                n = document.createElement("button"),
                ...
                m && (n = S(this.instance.localize(m.tpl)),
                typeof m.click == "function" && n.addEventListener("click", s=>{
                    s.preventDefault(),
                    s.stopPropagation(),
    ...
    var bs = {
        Hash: class extends Y {
            ...
            onClose(a) {
                ...
                if (!Qt)
                    try {
                        window.history.replaceState({}, document.title, window.location.pathname + window.location.search + (Li || ""))
                    } catch {}
            }
            attach() {
                let a = this.instance;
        ...
        Thumbs: te,
        Toolbar: ee
    }, Ii = "with-fancybox", De = "hide-scrollbar", Ri = "--fancybox-scrollbar-compensate", Vi = "--fancybox-body-margin", Xe = "aria-hidden", Ge = "is-using-tab", Ne = "is-animated", Yi = "is-compact", _i = "is-loading", Te = "is-opening", At = "has-caption", rt = "disabled", tt = "tabindex", Di = "download", Ae = "href", lt = "src", K = a=>typeof a == "string", Xi = function() {
        var a = window.getSelection();
        return !!a && a.type === "Range"
    }, G, N = null, et = null, Gi = 0, Ni = 0, Ti = 0, Ai = 0, ct = new Map, gs = 0, E = class a extends yt {
        get isIdle() {
            return this.idle
        }
        get isCompact() {
        ...
        init() {
            ...
            ;
            this.option("Fullscreen.autoStart") && G && !G.isFullscreen() ? G.request().then(()=>{
                this.startedFs = !0,
                t()
            }
            ).catch(()=>t()) : t()
        ...
        initLayout() {
            ...
            if (n) {
                ...
                N && et || (N = document.createElement("span"),
                v(N, "fancybox-focus-guard"),
                N.setAttribute(tt, "0"),
                N.setAttribute(Xe, "true"),
                N.setAttribute("aria-label", "Focus guard"),
                et = N.cloneNode(),
                (t = n.parentElement) === null || t === void 0 || t.insertBefore(N, n),
                ...
                this.option("closeExisting"))
                    for (let o of ct.values())
                        o.id !== this.id && o.close();
                else
                    this.option("animated") && (v(n, Ne),
                    setTimeout(()=>{
        ...
        initCarousel(t) {
            ...
            if (!i)
                return;
            let n = this.carousel = new dt(i,V({}, {
                slides: t,
                transition: "fade",
                Panzoom: {
            ...
            n.on("Panzoom.touchStart", ()=>{
                ...
                !((o = document.activeElement) === null || o === void 0) && o.closest(".f-thumbs") && ((l = this.container) === null || l === void 0 || l.focus())
            }
            ),
            n.on("settle", ()=>{
            ...
            this.option("dragToClose") && (n.on("Panzoom.afterTransform", (o,l)=>{
                let c = this.getSlide();
                if (c && Se(c.el))
                    return;
            ...
            n.on("Panzoom.touchEnd", (o,l,c)=>{
                var u;
                let m = this.getSlide();
                if (m && Se(m.el) || l.isMobile && document.activeElement && ["TEXTAREA", "INPUT"].indexOf((u = document.activeElement) === null || u === void 0 ? void 0 : u.nodeName) !== -1)
                    return;
                let s = Math.abs(l.dragOffset.y);
                l.lockedAxis === "y" && (s >= 200 || s >= 50 && l.dragOffset.time < 300) && (c && c.cancelable && c.preventDefault(),
            ...
            n.on(["refresh", "change"], o=>{
                ...
                if (!o.isInfinite) {
                    for (let m of l.querySelectorAll("[data-fancybox-next]"))
                        o.page < o.pages.length - 1 ? (m.removeAttribute(rt),
                        m.removeAttribute(tt)) : (m.setAttribute(rt, ""),
                        m.setAttribute(tt, "-1"));
                    for (let m of l.querySelectorAll("[data-fancybox-prev]"))
                        o.page > 0 ? (m.removeAttribute(rt),
                        m.removeAttribute(tt)) : (m.setAttribute(rt, ""),
                        m.setAttribute(tt, "-1"))
                }
                let c = this.getSlide();
                ...
                for (let m of l.querySelectorAll("[data-fancybox-download]")) {
                    ...
                    u ? (m.removeAttribute(rt),
                    m.removeAttribute(tt),
                    m.setAttribute(Ae, u),
                    m.setAttribute(Di, s || u),
                    m.setAttribute("target", "_blank")) : (m.setAttribute(rt, ""),
                    m.setAttribute(tt, "-1"),
        ...
        onClick(t) {
            ...
            if (o.closest("[data-fancybox-next]"))
                return t.preventDefault(),
                void this.next();
            if (t.type === "click" && t.detail === 0 || Math.abs(t.pageX - Gi) > 30 || Math.abs(t.pageY - Ni) > 30)
                return;
            let l = document.activeElement;
            if (Xi() && l && i.contains(l))
                return;
            ...
            if (o.closest(".fancybox__content")) {
                ...
                o.closest(".fancybox__carousel") && !o.matches(Ie) && (c = this.option("backdropClick"));
            c === "close" ? (t.preventDefault(),
            this.close(t)) : c === "next" ? (t.preventDefault(),
            this.next()) : c === "prev" && (t.preventDefault(),
            this.prev())
        }
        onWheel(t) {
            let e = t.target
            ...
            let n = i === "slide"
              , o = [-t.deltaX || 0, -t.deltaY || 0, -t.detail || 0].reduce(function(u, m) {
                return Math.abs(m) > Math.abs(u) ? m : u
            })
              , l = Math.max(-1, Math.min(1, o))
              , c = Date.now();
            this.pwt && c - this.pwt < 300 ? n && t.preventDefault() : (this.pwt = c,
            this.emit("wheel", t, l),
            t.defaultPrevented || (i === "close" ? (t.preventDefault(),
            this.close(t)) : i === "slide" && (St(e) || (t.preventDefault(),
            this[l > 0 ? "prev" : "next"]()))))
        }
        onScroll() {
        ...
        onKeydown(t) {
            ...
            let n = t.composedPath()[0]
              ...
              , l = o && o.contains("f-button") || n.dataset.carouselPage || n.dataset.carouselIndex;
            if (e !== "Escape" && !l && R(n) && (n.isContentEditable || ["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(n.nodeName) !== -1) || (t.key === "Tab" ? v(this.container, Ge) : U(this.container, Ge),
            t.ctrlKey || t.altKey || t.shiftKey))
                return;
            this.emit("keydown", e, t);
            let c = i[e];
            c && typeof this[c] == "function" && (t.preventDefault(),
            this[c]())
        }
        onResize() {
            let t = this.container;
        ...
        manageCaption(t=void 0) {
            ...
            c && this.caption && (this.caption.remove(),
            this.caption = null),
            l && !this.caption)
                for (let r of ((e = this.carousel) === null || e === void 0 ? void 0 : e.slides) || [])
                    r.captionEl && (r.captionEl.remove(),
                    r.captionEl = void 0,
                    U(r.el, At),
                    (i = r.el) === null || i === void 0 || i.removeAttribute("aria-labelledby"));
            if (t || (t = this.getSlide()),
            !t || l && !this.isCurrentSlide(t))
                return;
            let u = t.el
            ...
            if (c) {
                ...
                this.caption = s;
            s && (s.innerHTML = "",
            K(m) || typeof m == "number" ? s.innerHTML = m + "" : m instanceof HTMLElement && s.appendChild(m))
        }
        checkFocus(t) {
            this.focus(t)
        }
        focus(t) {
            ...
            if (!o || !l || !t && i && o.contains(i))
                return;
            let c = this.getSlide()
              , u = c && c.state === I.Ready ? c.el : null;
            if (!u || u.contains(i) || o === i)
                return;
            ...
            let d = null;
            t ? (!n || s.indexOf(n) < 0) && (d = r || o,
            s.length && (i === et ? d = s[0] : this.lastFocus !== o && i !== N || (d = s[s.length - 1]))) : d = c && c.type === "image" ? o : r || o,
            d && wi(d),
        ...
        isTopmost() {
            var t;
            return ((t = a.getInstance()) === null || t === void 0 ? void 0 : t.id) == this.id
        }
        animate(t=null, e="", i) {
            if (!t || !e)
                return void (i && i());
            this.stop(t);
            let n = o=>{
                o.target === t && t.dataset.animationName && (t.removeEventListener("animationend", n),
        ...
        setContent(t, e="", i=!0) {
            ...
            let o = null;
            if (R(e) ? o = e : (o = S(e + ""),
            R(o) || (o = document.createElement("div"),
            o.innerHTML = e + "")),
            ...
            o && R(o) ? (v(o, "fancybox__content"),
            t.id && o.setAttribute("id", t.id),
            n.classList.add(`has-${t.error ? "error" : t.type || "unknown"}`),
            n.prepend(o),
            o.style.display === "none" && (o.style.display = ""),
            getComputedStyle(o).getPropertyValue("display") === "none" && (o.style.display = t.display || this.option("defaultDisplay") || "flex"),
            t.contentEl = o,
        ...
        revealContent(t, e) {
            ...
            this.hideLoading(t),
            t.state = I.Opening,
            (e = this.isOpeningSlide(t) ? e === void 0 ? this.optionFor(t, "showClass") : e : "f-fadeIn") ? this.animate(n, e, ()=>{
                this.done(t)
            }
            ) : this.done(t))
        }
        done(t) {
            this.isClosing() || (t.state = I.Ready,
            this.emit("done", t),
            v(t.el, "is-done"),
            ...
            this.isOpeningSlide(t) && (U(this.container, Te),
        ...
        hideLoading(t) {
            ...
            if (!e)
                return;
            let i = t.spinnerEl;
            this.isClosing() ? i?.remove() : (U(e, _i),
            i && this.animate(i, "f-fadeOut", ()=>{
                i.remove()
            }
            ),
            t.state === I.Loading && (this.emit("loaded", t),
            t.state = I.Ready))
        }
        setError(t, e) {
            if (this.isClosing())
        ...
        close(t, e) {
            ...
            ;
            this.startedFs && G && G.isFullscreen() ? Promise.resolve(G.exit()).then(()=>n()) : n()
        }
        clearIdle() {
        ...
        toggleFullscreen() {
            G && (G.isFullscreen() ? G.exit() : G.request().then(()=>{
                this.startedFs = !0
            }
            ))
        }
        ...
        proceedClose(t, e) {
            ...
            this.emit("close", t),
            this.state !== O.CustomClosing ? (e === void 0 && c && (e = this.optionFor(c, "hideClass")),
            e && c ? (this.animate(c.contentEl, e, ()=>{
        ...
        static bind(t, e, i) {
            if (!Ft)
                return;
            let n, o = "", l = {};
            if (t === void 0 ? n = document.body : K(t) ? (n = document.body,
            o = t,
            typeof e == "object" && (l = e || {})) : (n = t,
            K(e) && (o = e),
            typeof i == "object" && (l = i || {})),
            !n || !R(n))
                return;
        ...
        static unbind(t, e) {
            ...
            o && n && o.delete(n),
            n && o || (a.openers.delete(i),
            i.removeEventListener("click", a.fromEvent))
        }
        static destroy() {
            let t;
            for (; t = a.getInstance(); )
        ...
        static fromEvent(t) {
            ...
            if (!(e && e instanceof Element))
                return;
            let n, o, l, c;
            if ([...a.openers].reverse().find(([f,b])=>!(!f.contains(e) || ![...b].reverse().find(([p,g])=>{
                let Q = e.closest(p);
                return !!Q && (n = f,
                o = p,
                l = Q,
            ...
            if ((!e || d || s) && (u = [].slice.call(n.querySelectorAll(o))),
            e && !s && (u = d ? u.filter(f=>f.getAttribute(`${r}`) === d) : [e]),
            !u.length)
                return;
            let h = a.getInstance();
            return h && h.options.triggerEl && u.indexOf(h.options.triggerEl) > -1 ? void 0 : (e && (m.startIndex = u.indexOf(e)),
            a.fromNodes(u, m))
        }
        static fromSelector(t, e, i) {
            let n = null
              , o = ""
              , l = {};
            if (K(t) ? (n = document.body,
            o = t,
            typeof e == "object" && (l = e || {})) : t instanceof HTMLElement && K(e) && (n = t,
            o = e,
            typeof i == "object" && (l = i || {})),
            !n || !o)
                return !1;
            let c = a.openers.get(n);
            return !!c && (l = V({}, c.get(o) || {}, l),
        ...
        static fromNodes(t, e) {
            ...
            let i = [];
            for (let n of t) {
                let o = n.dataset || {}, l = o[lt] || n.getAttribute(Ae) || n.getAttribute("currentSrc") || n.getAttribute(lt) || void 0, c, u = e.delegate, m;
                u && i.length === e.startIndex && (c = u instanceof HTMLImageElement ? u : u.querySelector("img:not([aria-hidden])")),
                c || (c = n instanceof HTMLImageElement ? n : n.querySelector("img:not([aria-hidden])")),
                c && (m = c.currentSrc || c[lt] || void 0,
                !m && c.dataset && (m = c.dataset.lazySrc || c.dataset[lt] || void 0));
                let s = {
                    src: l,
                    triggerEl: n,
                    thumbEl: c,
        ...
        static getInstance(t) {
            return t ? ct.get(t) : Array.from(ct.values()).reverse().find(e=>!e.isClosing() && e) || null
        }
        static getSlide() {
            var t;
            return ((t = a.getInstance()) === null || t === void 0 ? void 0 : t.getSlide()) || null
        }
        static show(t=[], e={}) {
            return new a(t,e)
        }
    ...
    var Ke = class extends _ {
        ...
        showImage(a) {
            let t = a.target;
            "clicks"in t.dataset ? t.setAttribute("data-clicks", parseInt(t.dataset.clicks) + 1) : t.setAttribute("data-clicks", 1);
            ...
            i.includes("https://") || (n = "inline")),
            "imagemax"in t.dataset && "imageoverflow"in t.dataset && e > parseInt(t.dataset.imagemax) && (i = t.dataset.imageoverflow,
            n = "inline",
            this.audioEnded()),
            n == "inline" ? new E([{
                src: `#${i}`,
                ...
                on: {
                    reveal: o=>{
                        for (let c of o.getSlide().contentEl.querySelectorAll("video"))
                            c.play();
                        let l = this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets");
                        "bgm"in o.getSlide().contentEl.dataset && l.playBGM(o.getSlide().contentEl.dataset.bgm);
                        for (let c of o.getSlide().contentEl.querySelectorAll("audio")) {
                    ...
                    ,
                    close: o=>{
                        for (let u of o.getSlide().contentEl.querySelectorAll("video"))
                            u.pause();
                        let l = this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets")
        ...
        showContent(a) {
            ...
            document.getElementById(t) ? this.fancyContent(t) : fetch(t).then(async i=>{
                let n = document.createElement("div");
                n.setAttribute("id", t),
        ...
        playSound(a) {
            this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets").playSound(a.params.sound)
        }
        playAudio(a) {
            let t = a.target.dataset.audio
              , e = document.getElementById(t);
            if (e.paused) {
                this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets").playAudio(t);
        ...
        audioEnded() {
            this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets").audioEnded()
        }
        audioPaused() {
            this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets").audioPaused()
        }
        printImage(a) {
            ...
            if (t) {
                ...
                e.document.open(),
                e.document.write(`<html><head><meta name="viewport" content="width=device-width, initial-scale=1.0" /></head><body onload="window.print(); window.close()" onafterprint="window.close()"><img src="${t.src}" style="width: 100%; height: auto" /></body></html>`),
                e.document.close()
            }
        }
        nextImage(a) {
        ...
        replaceSources(a) {
            this.application.getControllerForElementAndIdentifier(document.getElementById("desk_frame"), "secrets").replaceSources(a.params.replacements)
        }
    }
    ;
    var ti = {};
    ...
    var qe = class extends _ {
        flipImage(a) {
            for (let t of document.querySelectorAll(`#${a.params.image}`)) {
                if (t.classList.contains("animate-flip-in"))
                    return !1;
    ...
    var vt = class extends _ {
        connect() {
            this.hasVideo1Target && this.loaded1Value == !1 && (this.badCodes = [],
        ...
        initiateSFX() {
            this.sfx = {},
            this.sfx.begin = new L.Howl({
                src: ["assets/sfx/begin.mp3"]
            }),
            this.sfx.bubble = new L.Howl({
                src: ["assets/sfx/bubble.mp3"]
            }),
            ...
            this.sfx.error = new L.Howl({
                src: ["assets/sfx/error.mp3"]
            }),
            this.sfx.pop = new L.Howl({
                src: ["assets/sfx/pop.mp3"]
            }),
            this.sfx.lose = new L.Howl({
                src: ["assets/sfx/lose.mp3"]
            }),
            this.sfx.soul = new L.Howl({
                src: ["assets/sfx/soul.mp3"]
            }),
            this.sfx.thunder1 = new L.Howl({
                src: ["assets/sfx/thunder1.mp3"]
            }),
            this.sfx.thunder2 = new L.Howl({
        ...
        screenOccupiedValueChanged() {
            this.screenOccupiedValue ? this.buttonOverlayTarget.classList.add("occupied") : this.buttonOverlayTarget.classList.remove("occupied")
        }
        expandImage(a) {
            new E([{
                src: a.target.src
        ...
        fancyContent(a) {
            ...
            if (e) {
                ...
                let m = c + 1;
                m > u.length - 1 && (m = u.length - 1),
                e.dataset.imageshown = m
            }
            ...
            if (n)
                ...
                (t.classList.contains("html") || t.classList.contains("text") || t.classList.contains("link") || t.classList.contains("image") || t.classList.contains("video") || t.classList.contains("audio")) && new E([{
                    src: `#${a}`,
                    type: "inline"
                }],{
                    backdropClick: !1,
                    ...
                    on: {
                        reveal: c=>{
                            this.sfx !== void 0 && (i ? this.sfx[i].play() : this.sfx.reveal.play()),
                            this.bgm !== void 0 && c.getSlide().contentEl.children.length > 0 && "bgm"in c.getSlide().contentEl.children[0].dataset && this.playBGM(c.getSlide().contentEl.children[0].dataset.bgm);
                        ...
                        close: c=>{
                            this.sfx !== void 0 && this.sfx.unreveal.play(),
                            this.bgm !== void 0 && this.bgmPlayingValue != "rain" && this.playBGM("rain");
        ...
        begin() {
            ...
            this.startScreenTarget.classList.add("pointer-events-none", "opacity-0"),
            ...
            this.begunValue || (this.sfx.button.play(),
            this.sfx.begin.play(),
            this.playBGM("rain")),
            this.begunValue = !0
        }
        submit(a) {
            if (a.preventDefault(),
            this.buttonTarget.classList.contains("disabled"))
                return !1;
            if (this.fieldTarget.classList.remove("animate-error"),
            ...
            window.hasOwnProperty("plausible") && window.plausible("Code", {
                props: {
                    code: t
                }
            });
            ...
            if (e)
                e.classList.contains("part-of-ui") ? this.flashError() : e.classList.contains("text") ? this.randomText(t) : e.classList.contains("link") ? this.randomLink(t) : e.classList.contains("image") ? this.fancyImage(t) : e.classList.contains("video") ? this.playVideo(t) : e.classList.contains("audio") ? this.playAudio(t) : e.classList.contains("overlays") ? this.randomOverlay(t) : e.classList.contains("replacements") ? this.replaceSources(t) : this.fancyContent(t),
                ...
                fetch("https://codes.thisisnotawebsitedotcom.com/", {
                    ...
                    if (!n.ok)
                        this.flashError(),
                        n.status == "429" ? this.disableForm(3e4) : n.status == "404" ? this.badCodes.push(t) : this.disableForm(250);
                    else {
                        ...
                        if (o == "text/html") {
                            ...
                            l.children[0].classList.contains("has-text") ? (l.classList.add("hidden", "text"),
                            document.body.appendChild(l),
                            this.randomText(t)) : l.children[0].classList.contains("has-link") ? (l.classList.add("hidden", "link"),
                            document.body.appendChild(l),
                            this.randomLink(t)) : l.children[0].classList.contains("audio") ? (l.children[0].setAttribute("id", t),
                            document.body.appendChild(l.children[0]),
                            this.playAudio(t)) : l.children[0].classList.contains("has-overlays") ? (l.children[0].setAttribute("id", t),
                            l.classList.add("hidden", "overlays"),
                            document.body.appendChild(l),
                            this.randomOverlay(t)) : l.children[0].classList.contains("has-replacements") ? (l.children[0].setAttribute("id", t),
                            l.classList.add("hidden", "replacements"),
                            document.body.appendChild(l),
                            this.replaceSources(t)) : (l.classList.add("hidden", "html"),
                            document.body.appendChild(l),
                            this.fancyContent(t))
                        } else if (o == "video/mp4") {
                            let l = await n.blob()
                            ...
                            u.setAttribute("data-action", "ended->secrets#audioEnded pause->secrets#audioEnded"),
                            m.src = c,
        ...
        disableForm(a=1e3) {
            ...
            a > 1e3 && (this.buttonOverlayTarget.classList.add("disabled"),
        ...
        adjustVolume() {
            if (this.volumeValue = this.volumeSliderTarget.value / 100,
            this.volumeValue > 0) {
                if (this.mutedValue = !1,
        ...
        mutedValueChanged() {
            if (this.hasMuteButtonTarget && (this.mutedValue ? (this.muteButtonTarget.classList.add("muted"),
            this.muteButtonTarget.classList.remove("unmuted")) : (this.muteButtonTarget.classList.remove("muted"),
            this.muteButtonTarget.classList.add("unmuted"))),
            this.hasScreenTarget && (this.mutedValue ? (this.screenTarget.volume = 0,
            this.screenTarget.muted = !0) : (this.screenTarget.volume = this.volumeValue,
        ...
        playVideo(a="") {
            if (this.screenOccupiedValue)
                this.videoPlayingValue.includes("static") && (this.screenTarget.pause(),
                this.videoEnded());
            else {
                if (typeof a == "string") {
                    let t = document.getElementById(a)
                    ...
                    "linkatend"in t.dataset && "endsat"in t.dataset && setTimeout(function() {
        ...
        videoEnded() {
            this.videoPlayingValue && (this.screenLoopsValue > 0 ? (this.screenLoopsValue -= 1,
            this.screenTarget.currentTime = 0,
            this.screenTarget.play()) : (this.videoPlayingValue = "",
            this.screenOverlayTarget.classList.remove("!opacity-100"),
            this.screenStaticTarget.classList.remove("!opacity-100"),
        ...
        videoLoop() {
            ...
            this.video1Target.play(),
            this.video2Target.play(),
            Math.floor(Math.random() * 6) + 1 > 4 ? (this.video2Target.classList.remove("hidden"),
            setTimeout(this.lightningSFX.bind(this), 2500)) : this.video2Target.classList.add("hidden")
        }
        staticSFX() {
            this.staticPlayingValue && this.sfx[this.staticPlayingValue].stop();
        ...
        playBGM(a) {
            this.bgmPlayingValue && this.bgmPlayingValue != a && this.bgm[this.bgmPlayingValue].stop(),
            this.bgmPlayingValue = a,
            this.resumeBGM()
        }
        pauseBGM() {
            this.bgmPlayingValue && this.bgm[this.bgmPlayingValue].playing() && this.bgm[this.bgmPlayingValue].pause()
        }
        resumeBGM() {
            this.bgmPlayingValue && !this.bgm[this.bgmPlayingValue].playing() && this.bgm[this.bgmPlayingValue].play()
        }
        playAudio(a) {
            if (!this.screenOccupiedValue) {
                ...
                "audiolog"in t.dataset ? this.playVideo("audiolog") : "music"in t.dataset ? this.playVideo("music") : this.playVideo("small"),
        ...
        triggerSound(a) {
            this.sfx !== void 0 && a.params.sound in this.sfx && this.sfx[a.params.sound].play()
        }
        audioEnded() {
            ...
            if (a) {
                ...
                this.videoPlayingValue && (this.screenLoopsValue = 0,
                this.videoEnded()),
                this.resumeBGM(),
                this.screenOccupiedValue = !1
            }
        ...
        randomOverlay(a) {
            ...
            if (e.length > 0) {
                ...
                let o = document.createElement("div");
                o.classList.add("absolute", "top-0", "right-0", "left-0", "bottom-0", "opacity-0", "pointer-events-none", "z-30", "animate-overlay", "origin-center"),
                o.appendChild(n),
                document.getElementById("desk_form").appendChild(o),
                this.sfx.pop.play()
            } else
                "alloverlays"in t.dataset && this.showText(t.dataset.alloverlays)
        }
        showText(a) {
        ...
        textCountdown() {
            ...
            this.textVisibleForSeconds > 0 ? setTimeout(this.textCountdown.bind(this), 1e3) : this.videoPlayingValue || this.resetScreen()
        }
        inputUpdate(a) {
            a.target.value.length > 0 ? this.clearButtonTarget.classList.add("active") : this.clearButtonTarget.classList.remove("active")
        }
        clearForm() {
        ...
        replaceSources(a) {
            let t = [];
            a.includes(",") ? t = a.split(";") : t = document.getElementById(a).children[0].dataset.replacements.split(";");
            for (let e of t) {
                let i = e.split(",")
                  , n = i[0]
                  , o = i[1];
                if (n.includes("sfx_"))
                    ...
                    let l = document.getElementById(n)
                      , c = l.children[0];
                    c.src != o && (n.includes("desk") && (this.startScreenTarget.classList.remove("opacity-0"),
    ...
    ;
    se(vt, "targets", ["button", "field", "clearButton", "buttonOverlay", "badOverlay", "screenOverlay", "screenText", "screen", "screenStatic", "screenSource", "startScreen", "video1", "video2", "shadow", "volume", "volumeSlider", "muteButton", "loader", "title"]),
    se(vt, "values", {
        volume: {
            type: Number,
            default: .25
    ...
    Object.entries(en).forEach(([a,t])=>{
        if (a.includes("_controller.") || a.includes("-controller.")) {
            let e = a.replace("./controllers/", "").replace(/[_-]controller\..*$/, "").replace(/_/g, "-").replace(/\//g, "--");
